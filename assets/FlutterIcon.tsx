...
function FlutterIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            <path fill="var(--gray12)" d="M81.6 93.9l-20-20-19.4 19.6 19.4 19.6z" />
            <path fill="var(--gray12)" d="M115.7 128L81.6 93.9l-20 19.2L76.3 128z" />
            <linearGradient
                id="prefix__a"
                ...
                x2={86.825}
                y2={99.399}>
                <stop offset={0} stopColor="var(--gray12)" />
                <stop offset={0.63} stopColor="var(--gray12)" />
