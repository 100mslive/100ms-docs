...
To know the limitations to Token Generation Endpoint you can read our [docs](https://docs.100ms.live/v2/server-side/100ms-quickstart-app-server#limitations-to-token-generation-endpoint).
...
`@100mslive/hms-video-react` provides us a flux based reactive data store layer over 100ms core SDK.This makes state management super easy.
...
```jsx
import { HMSRoomProvider, useHMSStore } from '@100mslive/hms-video-react';
import './index.css';
