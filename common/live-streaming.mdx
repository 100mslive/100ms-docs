...
1. Select if viewers can be invted to join the stage. This will enable the broadcaster and co-broadcaster to temporarily invite viewers on stage, and remove them later
...
-   `broadcaster`: This role represents a streamer, on stage, who can publish their audio/video. There can be multiple participants who join as a broadcaster
-   `co-broadcaster`: This role represents a streamer, on stage, who can also publish their audio/video but cannot start or stop the stream
