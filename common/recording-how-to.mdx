...
-   **Room:** You can configure recording storage using [create a room](/server-side/v2/api-reference/Rooms/create-via-api) or [update a room](/server-side/v2/api-reference/Rooms/update-a-room) API uisng the [recording_info object](/server-side/v2/api-reference/Rooms/create-via-api#recording_info-arguments).
