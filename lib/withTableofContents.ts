...
const withTableofContents = (toc?: any[]) => () => (tree) => {
    ...
    const copytoClipBoard = (slug) => {
      console.log(window.location.origin, window.location.pathname, slug)
    }
