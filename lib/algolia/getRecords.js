    ...
    if (appId && adminKey && algoliaIndex && projectENV === 'prod') {
        ...
        const faqs = [
            ...
            },
            {
                ...
                "answers": "App token : Used to authenticate and allow end-users (peers) to join 100ms rooms. An App Token controls Peer identity and Room permissions in your real-time or Interactive live-streaming video application.\nManagement token : Used to authenticate all the requests to 100ms REST API (server-side)."
            },
            {
                "platform": "Common",
                "questions": "Is there an easy method to create an app token?",
                "answers": "Yes, you can get App tokens using a couple of approaches based on your app's lifecycle stage. Please check this guide for more information"
            },
            {
                "platform": "Common",
            ...
            {
                "platform": "Common",
                "questions": "I’d like to use the endpoint of my backend service instead of the 100ms token endpoint for app token generation in the React sample app. How do I do that?",
                "answers": "You can set up a token generation service on your end to create app tokens and block users that are trying to join without a token that's generated from your service. Please check authentication and tokens guide for more information.\n\nYou can update the code to point to your own token service (relevant code in the sample - see getToken(...)), your token endpoint can follow a similar interface: for a given room_id and role name, return the app token JWT.\n\nYou can continue using the existing routes (room_id/role) or set up your own routes in the cloned/forked code."
            },
            {
                "platform": "Common",
...
>>>>>>> 3b30b82121b98239d0cee5782432291623d572ca
            },
            {
                "platform": "Common",
