        ...
        const records = [
            {
                ...
                objectID: '/javascript/v2/foundation/faq#are-there-any-trial-account-limitations-0',
                link: '/javascript/v2/foundation/faq#are-there-any-trial-account-limitations',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-any-usage-analytics-dashboard-available-to-check-various-metrics-associated-with-our-account-1',
                link: '/javascript/v2/foundation/faq#is-there-any-usage-analytics-dashboard-available-to-check-various-metrics-associated-with-our-account',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#does-the-100ms-video-sdk-provide-analytics-on-room-session-and-each-user-including-data-such-as-time-spent-per-user-total-session-length-and-number-of-peers-in-a-room-2',
                link: '/javascript/v2/foundation/faq#does-the-100ms-video-sdk-provide-analytics-on-room-session-and-each-user-including-data-such-as-time-spent-per-user-total-session-length-and-number-of-peers-in-a-room',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-do-i-stop-using-100ms-token-endpoint-for-app-token-generation-in-the-react-sample-app-and-use-the-endpoint-of-my-backend-service-3',
                link: '/javascript/v2/foundation/faq#how-do-i-stop-using-100ms-token-endpoint-for-app-token-generation-in-the-react-sample-app-and-use-the-endpoint-of-my-backend-service',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-anyone-say-what-is-management_token-how-to-generate-this-so-that-i-need-to-create-room-via-postman-4',
                link: '/javascript/v2/foundation/faq#can-anyone-say-what-is-management_token-how-to-generate-this-so-that-i-need-to-create-room-via-postman',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-validity-of-management-and-client-token-5',
                link: '/javascript/v2/foundation/faq#what-is-the-validity-of-management-and-client-token',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#why-is-the-role-variable-needed-when-generating-the-app-token-6',
                link: '/javascript/v2/foundation/faq#why-is-the-role-variable-needed-when-generating-the-app-token',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-generate-two-application-access-tokens-one-for-qa-and-one-for-production-so-that-messages-from-qa-dont-flood-the-production-environment-7',
                link: '/javascript/v2/foundation/faq#can-we-generate-two-application-access-tokens-one-for-qa-and-one-for-production-so-that-messages-from-qa-dont-flood-the-production-environment',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-ensure-the-website-url-is-not-accessible-just-in-case-that-gets-known-8',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-ensure-the-website-url-is-not-accessible-just-in-case-that-gets-known',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#is-chat-in-a-separate-webrtc-channel-9',
                link: '/javascript/v2/foundation/faq#is-chat-in-a-separate-webrtc-channel',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#if-the-chat-function-is-not-needed-how-much-can-the-system-be-scaled-10',
                link: '/javascript/v2/foundation/faq#if-the-chat-function-is-not-needed-how-much-can-the-system-be-scaled',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#does-your-chat-feature-only-support-text-conversations-or-does-it-support-any-advanced-features-like-profanity-filtering-rich-media-file-uploads-etc-11',
                link: '/javascript/v2/foundation/faq#does-your-chat-feature-only-support-text-conversations-or-does-it-support-any-advanced-features-like-profanity-filtering-rich-media-file-uploads-etc',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-retrieve-chat-logs-during-a-session-12',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-retrieve-chat-logs-during-a-session',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-the-100ms-rtmp-streaming-bot-be-used-with-any-url-13',
                link: '/javascript/v2/foundation/faq#can-the-100ms-rtmp-streaming-bot-be-used-with-any-url',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-we-need-to-set-up-our-own-cdn-servers-for-rtmp-urls-or-can-we-attach-100ms-urls-to-video-elements-in-html-14',
                link: '/javascript/v2/foundation/faq#do-we-need-to-set-up-our-own-cdn-servers-for-rtmp-urls-or-can-we-attach-100ms-urls-to-video-elements-in-html',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-can-i-integrate-a-feature-similar-to-twitter-super-followers-using-100ms-also-i-want-to-only-allow-the-authenticated-users-is-that-possible-15',
                link: '/javascript/v2/foundation/faq#how-can-i-integrate-a-feature-similar-to-twitter-super-followers-using-100ms-also-i-want-to-only-allow-the-authenticated-users-is-that-possible',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-inspiration-behind-the-name-100ms-16',
                link: '/javascript/v2/foundation/faq#what-is-the-inspiration-behind-the-name-100ms',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#if-we-toggle-the-option-to-disable-room_idrole-link-format-how-should-we-access-the-meeting-from-your-github-react-app-starter-template-17',
                link: '/javascript/v2/foundation/faq#if-we-toggle-the-option-to-disable-room_idrole-link-format-how-should-we-access-the-meeting-from-your-github-react-app-starter-template',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#are-your-services-supported-in-all-countries-18',
                link: '/javascript/v2/foundation/faq#are-your-services-supported-in-all-countries',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-normal-to-be-able-to-create-only-one-custom-template-in-an-account-or-is-this-a-trial-restriction-19',
                link: '/javascript/v2/foundation/faq#is-it-normal-to-be-able-to-create-only-one-custom-template-in-an-account-or-is-this-a-trial-restriction',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#can-i-delete-apps-from-dashboard-20',
                link: '/javascript/v2/foundation/faq#can-i-delete-apps-from-dashboard',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-100ms-fully-optimized-for-mobile-devices-21',
                link: '/javascript/v2/foundation/faq#is-100ms-fully-optimized-for-mobile-devices',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-100ms-on-aws-or-another-cloud-infra-provider-22',
                link: '/javascript/v2/foundation/faq#is-100ms-on-aws-or-another-cloud-infra-provider',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-do-i-get-started-with-integrating-video-functionality-to-my-website-using-100ms-23',
                link: '/javascript/v2/foundation/faq#how-do-i-get-started-with-integrating-video-functionality-to-my-website-using-100ms',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-you-have-any-resources-for-designers-that-lets-them-know-what-parts-of-the-video-player-are-easily-configurable-so-they-can-make-designs-for-how-they-want-the-video-player-to-look-24',
                link: '/javascript/v2/foundation/faq#do-you-have-any-resources-for-designers-that-lets-them-know-what-parts-of-the-video-player-are-easily-configurable-so-they-can-make-designs-for-how-they-want-the-video-player-to-look',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-you-have-any-live-demo-app-with-some-deafult-ui-to-check-how-live-videoaudio-functionality-works-on-your-platform-25',
                link: '/javascript/v2/foundation/faq#do-you-have-any-live-demo-app-with-some-deafult-ui-to-check-how-live-videoaudio-functionality-works-on-your-platform',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-capture-some-images-shown-by-customers-during-a-call-for-storing-in-a-database-as-part-of-kyc-26',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-capture-some-images-shown-by-customers-during-a-call-for-storing-in-a-database-as-part-of-kyc',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#the-app-created-using-the-video-conferencing-starter-kit-is-powered-by-the-same-infra-as-the-live-applications-in-production-or-is-it-on-some-low-end-test-infrastructure-27',
                link: '/javascript/v2/foundation/faq#the-app-created-using-the-video-conferencing-starter-kit-is-powered-by-the-same-infra-as-the-live-applications-in-production-or-is-it-on-some-low-end-test-infrastructure',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#we-have-decided-to-use-100ms-to-integrate-live-streaming-into-our-app-how-can-we-get-started-28',
                link: '/javascript/v2/foundation/faq#we-have-decided-to-use-100ms-to-integrate-live-streaming-into-our-app-how-can-we-get-started',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-you-provide-more-information-on-the-live-stream-feature-29',
                link: '/javascript/v2/foundation/faq#can-you-provide-more-information-on-the-live-stream-feature',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-limit-for-room-size-in-live-streaming-30',
                link: '/javascript/v2/foundation/faq#what-is-the-limit-for-room-size-in-live-streaming',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-scalability-of-the-live-streaming-what-is-the-maximum-number-of-viewers-it-can-support-31',
                link: '/javascript/v2/foundation/faq#what-is-the-scalability-of-the-live-streaming-what-is-the-maximum-number-of-viewers-it-can-support',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-average-delay-of-the-live-streaming-32',
                link: '/javascript/v2/foundation/faq#what-is-the-average-delay-of-the-live-streaming',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-users-in-the-live-stream-send-chat-messages-themselves-33',
                link: '/javascript/v2/foundation/faq#can-users-in-the-live-stream-send-chat-messages-themselves',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-you-have-a-list-of-extra-plugins-that-can-be-added-to-live-sessions-34',
                link: '/javascript/v2/foundation/faq#do-you-have-a-list-of-extra-plugins-that-can-be-added-to-live-sessions',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-build-whiteboard-feature-on-100ms-platform-35',
                link: '/javascript/v2/foundation/faq#can-i-build-whiteboard-feature-on-100ms-platform',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#we-wanted-to-ask-specifics-on-pricing-and-how-we-could-calculate-an-estimated-cost-based-on-our-use-case-36',
                link: '/javascript/v2/foundation/faq#we-wanted-to-ask-specifics-on-pricing-and-how-we-could-calculate-an-estimated-cost-based-on-our-use-case',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-this-pricing-for-standard-definition-or-high-definition-in-the-pricing-calculator-its-telling-us-to-contact-you-guys-to-discuss-pricing-for-hd-37',
                link: '/javascript/v2/foundation/faq#is-this-pricing-for-standard-definition-or-high-definition-in-the-pricing-calculator-its-telling-us-to-contact-you-guys-to-discuss-pricing-for-hd',
                platformName: 'Common',
                keywords: [],
                content:
                    'You can use our pricing calculator for an estimate of the cost. You can also book a meeting with us directly for an in-depth discussion.'
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#does-billing-on-minutes-count-when-only-the-local-peer-is-joined-in-a-room-38',
                link: '/javascript/v2/foundation/faq#does-billing-on-minutes-count-when-only-the-local-peer-is-joined-in-a-room',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#would-you-be-able-to-tell-us-the-approximate-latency-of-a-creator-in-north-america-doing-a-real-time-video-conference-for-the-end-user-who-is-located-in-australia-39',
                link: '/javascript/v2/foundation/faq#would-you-be-able-to-tell-us-the-approximate-latency-of-a-creator-in-north-america-doing-a-real-time-video-conference-for-the-end-user-who-is-located-in-australia',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-the-latency-different-for-different-devices-40',
                link: '/javascript/v2/foundation/faq#is-the-latency-different-for-different-devices',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#hi-100ms-team-i-am-seeing-an-issue-where-it-keeps-saying-my-wifi-is-not-strong-even-though-it-is-it-seems-like-the-100ms-player-is-just-not-maintaining-a-strong-connection-to-my-wifi-41',
                link: '/javascript/v2/foundation/faq#hi-100ms-team-i-am-seeing-an-issue-where-it-keeps-saying-my-wifi-is-not-strong-even-though-it-is-it-seems-like-the-100ms-player-is-just-not-maintaining-a-strong-connection-to-my-wifi',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-dynamically-set-the-video-resolution-based-on-the-number-of-participants-so-if-there-are-just-two-its-1080-then-when-a-third-joins-it-drops-to-720-then-when-a-7th-joins-it-drops-to-360-or-something-like-that-42',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-dynamically-set-the-video-resolution-based-on-the-number-of-participants-so-if-there-are-just-two-its-1080-then-when-a-third-joins-it-drops-to-720-then-when-a-7th-joins-it-drops-to-360-or-something-like-that',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#for-a-given-room-what-is-the-max-of-concurrent-webrtc-connected-participants-43',
                link: '/javascript/v2/foundation/faq#for-a-given-room-what-is-the-max-of-concurrent-webrtc-connected-participants',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#whats-the-best-100ms-have-got-so-far-for-video-limits-44',
                link: '/javascript/v2/foundation/faq#whats-the-best-100ms-have-got-so-far-for-video-limits',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-are-max-tiles-config-100ms-can-support-45',
                link: '/javascript/v2/foundation/faq#what-are-max-tiles-config-100ms-can-support',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-maximum-number-of-people-that-can-be-supported-currently-46',
                link: '/javascript/v2/foundation/faq#what-is-the-maximum-number-of-people-that-can-be-supported-currently',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-maximum-capacity-for-group-calls-with-100ms-video-sdk-47',
                link: '/javascript/v2/foundation/faq#what-is-the-maximum-capacity-for-group-calls-with-100ms-video-sdk',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-any-limitations-on-the-number-of-rooms-or-peers-that-can-be-created-in-100ms-48',
                link: '/javascript/v2/foundation/faq#is-there-any-limitations-on-the-number-of-rooms-or-peers-that-can-be-created-in-100ms',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-limit-for-room-size-in-webrtc-49',
                link: '/javascript/v2/foundation/faq#what-is-the-limit-for-room-size-in-webrtc',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#does-your-latest-react-native-hms-sdk-target-or-compile-at-android-12-ie-targetsdkversion-31-we-are-trying-to-upgrade-our-apk-to-targetsdkversion-31-50',
                link: '/javascript/v2/foundation/faq#does-your-latest-react-native-hms-sdk-target-or-compile-at-android-12-ie-targetsdkversion-31-we-are-trying-to-upgrade-our-apk-to-targetsdkversion-31',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#hey-how-long-should-it-take-for-a-recording-to-show-up-in-our-s3-bucket-after-a-livestream-is-ended-for-both-beam-recording-and-sfu-51',
                link: '/javascript/v2/foundation/faq#hey-how-long-should-it-take-for-a-recording-to-show-up-in-our-s3-bucket-after-a-livestream-is-ended-for-both-beam-recording-and-sfu',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#whats-the-difference-between-the-beam-recording-vs-sfu-recording-52',
                link: '/javascript/v2/foundation/faq#whats-the-difference-between-the-beam-recording-vs-sfu-recording',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#will-the-100ms-bot-go-to-a-video-call-webpage-and-render-dynamic-pages-and-streamrecord-the-screen-or-will-it-collect-incoming-videoaudio-streams-only-53',
                link: '/javascript/v2/foundation/faq#will-the-100ms-bot-go-to-a-video-call-webpage-and-render-dynamic-pages-and-streamrecord-the-screen-or-will-it-collect-incoming-videoaudio-streams-only',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-split-room-recordings-as-per-some-control-at-our-end-54',
                link: '/javascript/v2/foundation/faq#can-we-split-room-recordings-as-per-some-control-at-our-end',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-use-the-same-room-id-but-have-separate-recordings-as-per-our-need-55',
                link: '/javascript/v2/foundation/faq#can-we-use-the-same-room-id-but-have-separate-recordings-as-per-our-need',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-can-we-retrieve-the-recording-from-a-room-56',
                link: '/javascript/v2/foundation/faq#how-can-we-retrieve-the-recording-from-a-room',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-make-a-recording-automatically-stop-after-a-certain-duration-or-at-a-specific-time-57',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-make-a-recording-automatically-stop-after-a-certain-duration-or-at-a-specific-time',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-retrieve-the-list-of-all-the-recordings-of-a-room-58',
                link: '/javascript/v2/foundation/faq#can-we-retrieve-the-list-of-all-the-recordings-of-a-room',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-make-a-recording-stop-when-a-specific-event-occurs-59',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-make-a-recording-stop-when-a-specific-event-occurs',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-s3listbucket-s3-permission-required-for-s3-bucket-access-60',
                link: '/javascript/v2/foundation/faq#is-s3listbucket-s3-permission-required-for-s3-bucket-access',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#we-would-like-to-record-a-live-stream-and-allow-users-to-continue-to-replay-the-recording-even-after-the-live-stream-has-ended-so-we-need-to-be-able-to-directly-access-the-recording-61',
                link: '/javascript/v2/foundation/faq#we-would-like-to-record-a-live-stream-and-allow-users-to-continue-to-replay-the-recording-even-after-the-live-stream-has-ended-so-we-need-to-be-able-to-directly-access-the-recording',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#web-recording-resolution-is-the-browser-itself-1080p-is-the-recording-1080p-62',
                link: '/javascript/v2/foundation/faq#web-recording-resolution-is-the-browser-itself-1080p-is-the-recording-1080p',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-use-the-100ms-browser-video-recorder-for-one-off-websites-63',
                link: '/javascript/v2/foundation/faq#can-we-use-the-100ms-browser-video-recorder-for-one-off-websites',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-can-we-debug-issues-with-uploading-video-recordings-to-an-s3-bucket-64',
                link: '/javascript/v2/foundation/faq#how-can-we-debug-issues-with-uploading-video-recordings-to-an-s3-bucket',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-permissions-are-needed-to-allow-video-recordings-to-be-uploaded-to-an-s3-bucket-65',
                link: '/javascript/v2/foundation/faq#what-permissions-are-needed-to-allow-video-recordings-to-be-uploaded-to-an-s3-bucket',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-long-does-it-take-for-the-composite-recording-to-be-ready-66',
                link: '/javascript/v2/foundation/faq#how-long-does-it-take-for-the-composite-recording-to-be-ready',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#is-cloud-recording-available-67',
                link: '/javascript/v2/foundation/faq#is-cloud-recording-available',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-export-chat-logs-from-one-of-the-front-end-clients-and-save-it-68',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-export-chat-logs-from-one-of-the-front-end-clients-and-save-it',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-for-us-to-upload-the-recordings-to-a-bucket-other-than-s3-specifically-cloudinary-although-just-being-able-to-do-a-generic-curl-upload-with-a-token-would-also-suffice-69',
                link: '/javascript/v2/foundation/faq#is-there-a-way-for-us-to-upload-the-recordings-to-a-bucket-other-than-s3-specifically-cloudinary-although-just-being-able-to-do-a-generic-curl-upload-with-a-token-would-also-suffice',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-the-system-scale-to-50k-100k-viewers-if-the-sdk-is-not-connected-and-we-just-want-the-m3u8-file-70',
                link: '/javascript/v2/foundation/faq#can-the-system-scale-to-50k-100k-viewers-if-the-sdk-is-not-connected-and-we-just-want-the-m3u8-file',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-access-in-depth-analytics-such-as-the-number-of-reconnections-drops-high-latency-and-live-metrics-71',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-access-in-depth-analytics-such-as-the-number-of-reconnections-drops-high-latency-and-live-metrics',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-the-100ms-live-stream-sdk-customisable-and-able-to-scale-to-millions-of-users-72',
                link: '/javascript/v2/foundation/faq#is-the-100ms-live-stream-sdk-customisable-and-able-to-scale-to-millions-of-users',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-you-share-some-documentation-on-your-information-security-practices-73',
                link: '/javascript/v2/foundation/faq#can-you-share-some-documentation-on-your-information-security-practices',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-ok-to-potentially-create-1000s-of-rooms-over-time-74',
                link: '/javascript/v2/foundation/faq#is-it-ok-to-potentially-create-1000s-of-rooms-over-time',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-you-platform-handle-end-to-end-encryption-between-just-2-users-75',
                link: '/javascript/v2/foundation/faq#can-you-platform-handle-end-to-end-encryption-between-just-2-users',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#is-100ms-soc-2-complainant-76',
                link: '/javascript/v2/foundation/faq#is-100ms-soc-2-complainant',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-teacher-handle-remote-users-student-screen-start-and-stop-like-remotely-muteunmute-of-av-77',
                link: '/javascript/v2/foundation/faq#can-teacher-handle-remote-users-student-screen-start-and-stop-like-remotely-muteunmute-of-av',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-get-data-on-how-many-users-are-online-78',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-get-data-on-how-many-users-are-online',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-i-can-specify-my-own-room_id-while-creating-a-room-79',
                link: '/javascript/v2/foundation/faq#is-there-a-way-i-can-specify-my-own-room_id-while-creating-a-room',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-mute-a-participant-using-a-serverside-api-80',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-mute-a-participant-using-a-serverside-api',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-disable-video-for-a-participant-using-a-serverside-api-81',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-disable-video-for-a-participant-using-a-serverside-api',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-can-i-handle-role-change-requests-on-my-backend-is-there-any-webhook-that-exists-or-is-planned-82',
                link: '/javascript/v2/foundation/faq#how-can-i-handle-role-change-requests-on-my-backend-is-there-any-webhook-that-exists-or-is-planned',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-handle-role-change-requests-on-the-backend-such-as-through-a-webhook-or-api-83',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-handle-role-change-requests-on-the-backend-such-as-through-a-webhook-or-api',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#just-want-to-know-that-if-we-create-role-with-api-and-want-changes-to-be-synced-in-react-sdk-so-that-we-can-use-that-role-84',
                link: '/javascript/v2/foundation/faq#just-want-to-know-that-if-we-create-role-with-api-and-want-changes-to-be-synced-in-react-sdk-so-that-we-can-use-that-role',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-the-functionality-of-disable-a-room-and-end-an-active-room-same-85',
                link: '/javascript/v2/foundation/faq#is-the-functionality-of-disable-a-room-and-end-an-active-room-same',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-close-a-room-using-a-serverside-api-86',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-close-a-room-using-a-serverside-api',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-any-way-to-limit-participants-in-a-room-87',
                link: '/javascript/v2/foundation/faq#is-there-any-way-to-limit-participants-in-a-room',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#have-quieries-related-to-for-backend-we-need-apis-to-create-room-and-joining-people-to-it-and-for-websitefrontend-need-guidance-for-components-like-video-buttons-and-participants-etc-88',
                link: '/javascript/v2/foundation/faq#have-quieries-related-to-for-backend-we-need-apis-to-create-room-and-joining-people-to-it-and-for-websitefrontend-need-guidance-for-components-like-video-buttons-and-participants-etc',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-schedule-these-rooms-for-a-certain-date-and-time-and-send-invites-to-certain-email-ids-89',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-schedule-these-rooms-for-a-certain-date-and-time-and-send-invites-to-certain-email-ids',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-disable-room-by-id-in-document-it-says-name-should-be-the-input-server-side-doc-90',
                link: '/javascript/v2/foundation/faq#can-we-disable-room-by-id-in-document-it-says-name-should-be-the-input-server-side-doc',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#we-need-to-know-if-there-is-a-way-to-end-an-active-session-programmatically-reset-the-room-so-that-everyone-is-kicked-from-the-meeting-and-it-starts-a-new-session-91',
                link: '/javascript/v2/foundation/faq#we-need-to-know-if-there-is-a-way-to-end-an-active-session-programmatically-reset-the-room-so-that-everyone-is-kicked-from-the-meeting-and-it-starts-a-new-session',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-you-explain-the-differences-between-the-hls-recording-and-beam-recording-webhook-events-92',
                link: '/javascript/v2/foundation/faq#can-you-explain-the-differences-between-the-hls-recording-and-beam-recording-webhook-events',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#for-incoming-webhooks-from-100ms-to-our-api-is-there-a-list-of-ips-that-can-be-whitelisted-93',
                link: '/javascript/v2/foundation/faq#for-incoming-webhooks-from-100ms-to-our-api-is-there-a-list-of-ips-that-can-be-whitelisted',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-an-api-call-we-can-make-to-set-the-webhook-url-and-headers-on-our-account-94',
                link: '/javascript/v2/foundation/faq#is-there-an-api-call-we-can-make-to-set-the-webhook-url-and-headers-on-our-account',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#i-am-trying-to-get-the-data-from-a-webhook-but-i-am-not-receiving-anything-is-there-a-way-to-troubleshoot-this-issue-95',
                link: '/javascript/v2/foundation/faq#i-am-trying-to-get-the-data-from-a-webhook-but-i-am-not-receiving-anything-is-there-a-way-to-troubleshoot-this-issue',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#were-having-an-issue-with-the-beam-recorder-our-development-sites-are-through-a-vpn-do-you-have-any-known-ip-addresses-that-the-beam-recorder-will-be-coming-from-so-we-can-whitelist-it-96',
                link: '/javascript/v2/foundation/faq#were-having-an-issue-with-the-beam-recorder-our-development-sites-are-through-a-vpn-do-you-have-any-known-ip-addresses-that-the-beam-recorder-will-be-coming-from-so-we-can-whitelist-it',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-you-have-some-static-ip-for-100ms-that-we-can-whitelist-your-hits-at-our-end-97',
                link: '/javascript/v2/foundation/faq#do-you-have-some-static-ip-for-100ms-that-we-can-whitelist-your-hits-at-our-end',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-you-have-any-gcp-ip-range-assigned-to-your-gcp-workloads-from-where-you-would-write-files-98',
                link: '/javascript/v2/foundation/faq#do-you-have-any-gcp-ip-range-assigned-to-your-gcp-workloads-from-where-you-would-write-files',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-filetypes-you-would-write-to-bucket-so-we-can-whitelist-them-99',
                link: '/javascript/v2/foundation/faq#what-is-the-filetypes-you-would-write-to-bucket-so-we-can-whitelist-them',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-does-pagination-between-tiles-affect-the-download-numbers-100',
                link: '/javascript/v2/foundation/faq#how-does-pagination-between-tiles-affect-the-download-numbers',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#we-use-169-video-but-would-like-to-crop-it-to-something-like-149-in-the-jsreact-client-what-is-the-best-way-to-achieve-this-with-css-101',
                link: '/javascript/v2/foundation/faq#we-use-169-video-but-would-like-to-crop-it-to-something-like-149-in-the-jsreact-client-what-is-the-best-way-to-achieve-this-with-css',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-the-100ms-video-sdk-built-on-react-frontend-and-provide-group-call-functionality-102',
                link: '/javascript/v2/foundation/faq#is-the-100ms-video-sdk-built-on-react-frontend-and-provide-group-call-functionality',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-we-provide-a-log-of-stats-for-nerds-103',
                link: '/javascript/v2/foundation/faq#do-we-provide-a-log-of-stats-for-nerds',
                platformName: 'Common',
                keywords: [],
                content: 'Yes'
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-does-a-host-differentiate-between-muting-the-remote-mic-so-that-nobody-can-hear-the-remote-vs-mute-the-remote-party-only-locally-so-that-others-can-still-hear-the-remote-104',
                link: '/javascript/v2/foundation/faq#how-does-a-host-differentiate-between-muting-the-remote-mic-so-that-nobody-can-hear-the-remote-vs-mute-the-remote-party-only-locally-so-that-others-can-still-hear-the-remote',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-add-the-feature-for-host-to-turn-the-guest-camera-on-mobile-to-face-front-105',
                link: '/javascript/v2/foundation/faq#can-we-add-the-feature-for-host-to-turn-the-guest-camera-on-mobile-to-face-front',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-play-a-static-video-as-a-participant-video-during-a-call-106',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-play-a-static-video-as-a-participant-video-during-a-call',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-100ms-integrate-with-obs-studio-can-i-stream-from-obs-to-100ms-107',
                link: '/javascript/v2/foundation/faq#can-100ms-integrate-with-obs-studio-can-i-stream-from-obs-to-100ms',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-customise-the-width-and-height-of-video-tile-which-we-are-getting-from-usevideolist-hook-108',
                link: '/javascript/v2/foundation/faq#can-we-customise-the-width-and-height-of-video-tile-which-we-are-getting-from-usevideolist-hook',
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-provision-developmenttesting-access-tokens-to-avoid-touching-production-datatemplates-in-development-and-staging-deploys-109',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-provision-developmenttesting-access-tokens-to-avoid-touching-production-datatemplates-in-development-and-staging-deploys',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-any-sandbox-mode-available-for-dev-environments-110',
                link: '/javascript/v2/foundation/faq#is-there-any-sandbox-mode-available-for-dev-environments',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-there-a-way-to-add-a-second-user-to-our-account-or-should-we-just-share-login-credentials-111',
                link: '/javascript/v2/foundation/faq#is-there-a-way-to-add-a-second-user-to-our-account-or-should-we-just-share-login-credentials',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-we-create-subaccount-in-existing-account-want-to-make-prod-and-non-prod-account-separate-112',
                link: '/javascript/v2/foundation/faq#can-we-create-subaccount-in-existing-account-want-to-make-prod-and-non-prod-account-separate',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#could-you-specify-multiple-webhook-urls-for-different-environments-under-the-same-account-113',
                link: '/javascript/v2/foundation/faq#could-you-specify-multiple-webhook-urls-for-different-environments-under-the-same-account',
                platformName: 'Common',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-register-for-another-100ms-account-with-same-email-address-114',
                link: '/javascript/v2/foundation/faq#can-i-register-for-another-100ms-account-with-same-email-address',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-delete-rooms-via-dashboard-or-api-115',
                link: '/javascript/v2/foundation/faq#can-i-delete-rooms-via-dashboard-or-api',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-do-i-limit-the-session-to-a-specified-duration-116',
                link: '/javascript/v2/foundation/faq#how-do-i-limit-the-session-to-a-specified-duration',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#how-do-i-record-a-room-117',
                link: '/javascript/v2/foundation/faq#how-do-i-record-a-room',
                platformName: 'Common',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-do-i-debug-blank-video-tile-while-rendering-118',
                link: '/javascript/v2/foundation/faq#how-do-i-debug-blank-video-tile-while-rendering',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#why-is-the-video-not-auto-playing-on-page-load-119',
                link: '/javascript/v2/foundation/faq#why-is-the-video-not-auto-playing-on-page-load',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#angular-why-is-video-not-auto-playing-even-though-muted-is-set-as-true-120',
                link: '/javascript/v2/foundation/faq#angular-why-is-video-not-auto-playing-even-though-muted-is-set-as-true',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-do-i-debug-no-audio-coming-in-the-room-121',
                link: '/javascript/v2/foundation/faq#how-do-i-debug-no-audio-coming-in-the-room',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-do-rtmp-out-live-stream-a-room-to-youtube-twitch-wowza-122',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-do-rtmp-out-live-stream-a-room-to-youtube-twitch-wowza',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-should-i-do-to-hide-the-beam-tile-showing-up-in-100ms-web-app-for-browser-based-recordingstreaming-123',
                link: '/javascript/v2/foundation/faq#what-should-i-do-to-hide-the-beam-tile-showing-up-in-100ms-web-app-for-browser-based-recordingstreaming',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-do-i-make-the-beam-bot-join-with-a-custom-role-for-dashboard-web-app-124',
                link: '/javascript/v2/foundation/faq#how-do-i-make-the-beam-bot-join-with-a-custom-role-for-dashboard-web-app',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#why-does-youtube-dashboard-shows-that-the-video-bitrate-is-less-than-the-recommended-bitrate-when-using-rtmp-out-125',
                link: '/javascript/v2/foundation/faq#why-does-youtube-dashboard-shows-that-the-video-bitrate-is-less-than-the-recommended-bitrate-when-using-rtmp-out',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#can-i-get-hls-out-for-a-room-126',
                link: '/javascript/v2/foundation/faq#can-i-get-hls-out-for-a-room',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-do-i-join-an-api-created-room-from-dashboard-web-app-127',
                link: '/javascript/v2/foundation/faq#how-do-i-join-an-api-created-room-from-dashboard-web-app',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#do-i-need-to-do-anything-to-handle-poor-internet-connection-128',
                link: '/javascript/v2/foundation/faq#do-i-need-to-do-anything-to-handle-poor-internet-connection',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-store-extra-information-with-a-peer-129',
                link: '/javascript/v2/foundation/faq#can-i-store-extra-information-with-a-peer',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#how-do-i-implement-raise-hand-130',
                link: '/javascript/v2/foundation/faq#how-do-i-implement-raise-hand',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#why-do-i-see-videos-getting-stuck-or-frozen-131',
                link: '/javascript/v2/foundation/faq#why-do-i-see-videos-getting-stuck-or-frozen',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#do-you-have-ui-components-132',
                link: '/javascript/v2/foundation/faq#do-you-have-ui-components',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-use-the-sdk-with-nextjs-angular-svelte-vuejs-etc-133',
                link: '/javascript/v2/foundation/faq#can-i-use-the-sdk-with-nextjs-angular-svelte-vuejs-etc',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#i-want-to-suggest-a-new-feature-134',
                link: '/javascript/v2/foundation/faq#i-want-to-suggest-a-new-feature',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#im-facing-an-issue-how-do-i-reach-out-135',
                link: '/javascript/v2/foundation/faq#im-facing-an-issue-how-do-i-reach-out',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#can-i-create-room-using-api-136',
                link: '/javascript/v2/foundation/faq#can-i-create-room-using-api',
                platformName: 'JavaScript',
                keywords: [],
                content: 'Yes.'
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#can-i-disable-a-room-137',
                link: '/javascript/v2/foundation/faq#can-i-disable-a-room',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#is-it-possible-to-create-and-manage-roles-using-apis-138',
                link: '/javascript/v2/foundation/faq#is-it-possible-to-create-and-manage-roles-using-apis',
                platformName: 'JavaScript',
                keywords: [],
                content: 'Yes.'
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#does-the-sdk-remembers-inputoutput-device-selection-for-future-joins-139',
                link: '/javascript/v2/foundation/faq#does-the-sdk-remembers-inputoutput-device-selection-for-future-joins',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-implement-custom-events-to-broadcast-or-sent-to-a-specific-person-in-the-room-140',
                link: '/javascript/v2/foundation/faq#can-i-implement-custom-events-to-broadcast-or-sent-to-a-specific-person-in-the-room',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-can-i-access-the-user-id-field-used-while-creating-the-token-after-joining-141',
                link: '/javascript/v2/foundation/faq#how-can-i-access-the-user-id-field-used-while-creating-the-token-after-joining',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID: '/javascript/v2/foundation/faq#how-can-i-implement-break-out-rooms-142',
                link: '/javascript/v2/foundation/faq#how-can-i-implement-break-out-rooms',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-locally-mute-a-remote-audio-track-143',
                link: '/javascript/v2/foundation/faq#can-i-locally-mute-a-remote-audio-track',
                platformName: 'JavaScript',
                keywords: [],
                content: 'Yes.'
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#can-i-process-video-before-sending-over-to-others-in-the-room-144',
                link: '/javascript/v2/foundation/faq#can-i-process-video-before-sending-over-to-others-in-the-room',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-to-disable-console-logs-if-im-using-the-web-sdk-145',
                link: '/javascript/v2/foundation/faq#how-to-disable-console-logs-if-im-using-the-web-sdk',
                platformName: 'JavaScript',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#what-is-the-maximum-allowed-duration-for-a-session-146',
                link: '/javascript/v2/foundation/faq#what-is-the-maximum-allowed-duration-for-a-session',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#how-can-i-get-the-hls-url-to-enable-live-stream-playback-147',
                link: '/javascript/v2/foundation/faq#how-can-i-get-the-hls-url-to-enable-live-stream-playback',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/javascript/v2/foundation/faq#i-get-type-errors-related-to-webrtc-stats-for-example-cannot-find-name-rtcinboundrtpstreamstats-148',
                link: '/javascript/v2/foundation/faq#i-get-type-errors-related-to-webrtc-stats-for-example-cannot-find-name-rtcinboundrtpstreamstats',
                platformName: 'JavaScript',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#could-not-invoke-hmssdkbuild-149',
                link: '/react-native/v2/foundation/faq#could-not-invoke-hmssdkbuild',
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#trackid-is-undefined-hmsview-is-rendering-blank-view-150',
                link: '/react-native/v2/foundation/faq#trackid-is-undefined-hmsview-is-rendering-blank-view',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#unable-to-join-meeting-or-getting-error-on-join-preview-functions-of-hms-instance-151',
                link: '/react-native/v2/foundation/faq#unable-to-join-meeting-or-getting-error-on-join-preview-functions-of-hms-instance',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#run-the-example-app-152',
                link: '/react-native/v2/foundation/faq#run-the-example-app',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#ui-components-to-test-all-the-features-and-functionalities-153',
                link: '/react-native/v2/foundation/faq#ui-components-to-test-all-the-features-and-functionalities',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#customize-track-settings-154',
                link: '/react-native/v2/foundation/faq#customize-track-settings',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#to-customize-more-settings-other-than-defined-on-above-mentioned-classes-like-video-quality-aspect-ratio-screenshare-quality-155',
                link: '/react-native/v2/foundation/faq#to-customize-more-settings-other-than-defined-on-above-mentioned-classes-like-video-quality-aspect-ratio-screenshare-quality',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#bluetooth_connect-permission-errorwarning-156',
                link: '/react-native/v2/foundation/faq#bluetooth_connect-permission-errorwarning',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#using-hms-with-another-webrtc-library-157',
                link: '/react-native/v2/foundation/faq#using-hms-with-another-webrtc-library',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            {
                title: 'Expo Support',
                objectID: '/react-native/v2/foundation/faq#expo-support-158',
                link: '/react-native/v2/foundation/faq#expo-support',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#change-streaming-video-aspect-ratio-159',
                link: '/react-native/v2/foundation/faq#change-streaming-video-aspect-ratio',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#how-to-get-hls-stream-url-160',
                link: '/react-native/v2/foundation/faq#how-to-get-hls-stream-url',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#video-player-to-play-hls-streams-161',
                link: '/react-native/v2/foundation/faq#video-player-to-play-hls-streams',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#how-to-muteunmute-specific-or-all-remote-peers-162',
                link: '/react-native/v2/foundation/faq#how-to-muteunmute-specific-or-all-remote-peers',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#how-to-muteunmute-specific-or-all-remote-peers-only-locally-163',
                link: '/react-native/v2/foundation/faq#how-to-muteunmute-specific-or-all-remote-peers-only-locally',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#restrict-remote-peer-from-speaking-after-their-audio-is-muted-164',
                link: '/react-native/v2/foundation/faq#restrict-remote-peer-from-speaking-after-their-audio-is-muted',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#enable-pip-mode-automatically-when-user-leaves-app-165',
                link: '/react-native/v2/foundation/faq#enable-pip-mode-automatically-when-user-leaves-app',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#enable-pip-mode-in-ios-device-166',
                link: '/react-native/v2/foundation/faq#enable-pip-mode-in-ios-device',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/react-native/v2/foundation/faq#using-hmssdk-instance-in-nested-components-without-passing-as-props-167',
                link: '/react-native/v2/foundation/faq#using-hmssdk-instance-in-nested-components-without-passing-as-props',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/react-native/v2/foundation/faq#how-many-hmsview-can-be-rendered-168',
                link: '/react-native/v2/foundation/faq#how-many-hmsview-can-be-rendered',
                platformName: 'React Native',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/flutter/v2/foundation/faq#flutter-version-compatibility-169',
                link: '/flutter/v2/foundation/faq#flutter-version-compatibility',
            ...
            },
            {
                ...
                objectID:
                    '/flutter/v2/foundation/faq#not-getting-event-updates-after-hot-reloadrestart-170',
                link: '/flutter/v2/foundation/faq#not-getting-event-updates-after-hot-reloadrestart',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/flutter/v2/foundation/faq#issues-while-using-hmssdk_flutter-with-flutter-30x-171',
                link: '/flutter/v2/foundation/faq#issues-while-using-hmssdk_flutter-with-flutter-30x',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/flutter/v2/foundation/faq#is-there-any-limit-to-the-number-of-hmsvideoview-on-screen-at-a-time-172',
                link: '/flutter/v2/foundation/faq#is-there-any-limit-to-the-number-of-hmsvideoview-on-screen-at-a-time',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/flutter/v2/foundation/faq#do-you-have-any-implementation-with-popular-state-management-libraries-173',
                link: '/flutter/v2/foundation/faq#do-you-have-any-implementation-with-popular-state-management-libraries',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID:
                    '/flutter/v2/foundation/faq#not-able-to-get-room-updates-after-joining-the-room-174',
                link: '/flutter/v2/foundation/faq#not-able-to-get-room-updates-after-joining-the-room',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/flutter/v2/foundation/faq#join-room-with-muted-audiovideo-175',
                link: '/flutter/v2/foundation/faq#join-room-with-muted-audiovideo',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/flutter/v2/foundation/faq#get-onpeerupdate-in-preview-176',
                link: '/flutter/v2/foundation/faq#get-onpeerupdate-in-preview',
                platformName: 'Flutter',
                keywords: [],
            ...
            },
            {
                ...
                objectID:
                    '/flutter/v2/foundation/faq#getting-updates-multiple-times-in-the-room-177',
                link: '/flutter/v2/foundation/faq#getting-updates-multiple-times-in-the-room',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                ...
                objectID: '/flutter/v2/foundation/faq#can-i-create-a-room-using-api-178',
                link: '/flutter/v2/foundation/faq#can-i-create-a-room-using-api',
                platformName: 'Flutter',
                keywords: [],
            ...
            },
            {
                ...
                objectID: '/flutter/v2/foundation/faq#receiving-too-many-logs-from-sdk-179',
                link: '/flutter/v2/foundation/faq#receiving-too-many-logs-from-sdk',
                platformName: 'Flutter',
                keywords: [],
                content:
            ...
            },
            {
                title: 'Do I need to do anything to handle poor internet connection?',
                objectID:
                    '/flutter/v2/foundation/faq#do-i-need-to-do-anything-to-handle-poor-internet-connection-180',
                link: '/flutter/v2/foundation/faq#do-i-need-to-do-anything-to-handle-poor-internet-connection',
                platformName: 'Flutter',
                keywords: [],
                content:
                    'Not much, just turn on a flag in dashboard, and show a proper UI when a video gets degraded/unsubscribed. More details here.'
            },
            {
                ...
                objectID:
                    '/flutter/v2/foundation/faq#how-do-i-implement-raise-hand-polls-in-application-181',
                link: '/flutter/v2/foundation/faq#how-do-i-implement-raise-hand-polls-in-application',
                platformName: 'Flutter',
                keywords: [],
                content: 'You can do using peer metadata.'
            },
            {
                title: 'Why do I see videos getting stuck or frozen?',
                objectID:
                    '/flutter/v2/foundation/faq#why-do-i-see-videos-getting-stuck-or-frozen-182',
                link: '/flutter/v2/foundation/faq#why-do-i-see-videos-getting-stuck-or-frozen',
                platformName: 'Flutter',
                keywords: [],
                content:
                    'If you have enabled subscribe degradation from the dashboard, the SDK might go in the degradation mode on poor internet connection turning off some videos to ensure good call quality. When this is done, a flag on the track will be turned on to let the UI know. The UI should treat it similar to the track turning off for purpose of displaying avatar etc. More details here.'
            },
            {
                title: 'What is the maximum allowed duration for a session?',
                objectID:
                    '/flutter/v2/foundation/faq#what-is-the-maximum-allowed-duration-for-a-session-183',
                link: '/flutter/v2/foundation/faq#what-is-the-maximum-allowed-duration-for-a-session',
                platformName: 'Flutter',
                keywords: [],
                content:
                    'The maximum allowed duration for a session on the 100ms platform is 12 hours.'
            ...
            {
                title: 'I want to suggest a new feature.',
                objectID: '/flutter/v2/foundation/faq#i-want-to-suggest-a-new-feature-184',
                link: '/flutter/v2/foundation/faq#i-want-to-suggest-a-new-feature',
                platformName: 'Flutter',
                keywords: [],
                content:
