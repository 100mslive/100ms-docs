...
async function updateIndex() {
    ...
    if (appId && adminKey && algoliaIndex && projectENV === 'prod') {
        ...
        const records = [
            ...
            {
                title: 'How can we minimize the latency?',
                objectID: '/docs/javascript/v2/foundation/faq#how-can-we-minimize-the-latency-41',
                link: '/javascript/v2/foundation/faq#how-can-we-minimize-the-latency',
                platformName: 'Common',
                keywords: []
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#hi-100ms-team-i-am-seeing-an-issue-where-it-keeps-saying-my-wifi-is-not-strong-even-though-it-is-it-seems-like-the-100ms-player-is-just-not-maintaining-a-strong-connection-to-my-wifi-42',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-possible-to-dynamically-set-the-video-resolution-based-on-the-number-of-participants-so-if-there-are-just-two-its-1080-then-when-a-third-joins-it-drops-to-720-then-when-a-7th-joins-it-drops-to-360-or-something-like-that-43',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#for-a-given-room-what-is-the-max-of-concurrent-webrtc-connected-participants-44',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#whats-the-best-100ms-have-got-so-far-for-video-limits-45',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-are-max-tiles-config-100ms-can-support-46',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-is-the-maximum-number-of-people-that-can-be-supported-currently-47',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-is-the-maximum-capacity-for-group-calls-with-100ms-video-sdk-48',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-any-limitations-on-the-number-of-rooms-or-peers-that-can-be-created-in-100ms-49',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-is-the-limit-for-room-size-in-webrtc-50',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#does-your-latest-react-native-hms-sdk-target-or-compile-at-android-12-ie-targetsdkversion-31-we-are-trying-to-upgrade-our-apk-to-targetsdkversion-31-51',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#hey-how-long-should-it-take-for-a-recording-to-show-up-in-our-s3-bucket-after-a-livestream-is-ended-for-both-beam-recording-and-sfu-52',
            ...
            {
                title: 'Hey 100ms team - is there a way for the beam recorder to record what is happening in the chat without the chat being open and covering any tiles?',
                objectID:
                    '/docs/javascript/v2/foundation/faq#hey-100ms-team-is-there-a-way-for-the-beam-recorder-to-record-what-is-happening-in-the-chat-without-the-chat-being-open-and-covering-any-tiles-53',
                link: '/javascript/v2/foundation/faq#hey-100ms-team-is-there-a-way-for-the-beam-recorder-to-record-what-is-happening-in-the-chat-without-the-chat-being-open-and-covering-any-tiles',
                platformName: 'Common',
                keywords: []
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#whats-the-difference-between-the-beam-recording-vs-sfu-recording-54',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#will-the-100ms-bot-go-to-a-video-call-webpage-and-render-dynamic-pages-and-streamrecord-the-screen-or-will-it-collect-incoming-videoaudio-streams-only-55',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-split-room-recordings-as-per-some-control-at-our-end-56',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-use-the-same-room-id-but-have-separate-recordings-as-per-our-need-57',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-can-we-retrieve-the-recording-from-a-room-58',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-possible-to-make-a-recording-automatically-stop-after-a-certain-duration-or-at-a-specific-time-59',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-retrieve-the-list-of-all-the-recordings-of-a-room-60',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-possible-to-make-a-recording-stop-when-a-specific-event-occurs-61',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-s3listbucket-s3-permission-required-for-s3-bucket-access-62',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#we-would-like-to-record-a-live-stream-and-allow-users-to-continue-to-replay-the-recording-even-after-the-live-stream-has-ended-so-we-need-to-be-able-to-directly-access-the-recording-63',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#web-recording-resolution-is-the-browser-itself-1080p-is-the-recording-1080p-64',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-use-the-100ms-browser-video-recorder-for-one-off-websites-65',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-can-we-debug-issues-with-uploading-video-recordings-to-an-s3-bucket-66',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-permissions-are-needed-to-allow-video-recordings-to-be-uploaded-to-an-s3-bucket-67',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-long-does-it-take-for-the-composite-recording-to-be-ready-68',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#is-cloud-recording-available-69',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-possible-to-export-chat-logs-from-one-of-the-front-end-clients-and-save-it-70',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-for-us-to-upload-the-recordings-to-a-bucket-other-than-s3-specifically-cloudinary-although-just-being-able-to-do-a-generic-curl-upload-with-a-token-would-also-suffice-71',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-the-system-scale-to-50k-100k-viewers-if-the-sdk-is-not-connected-and-we-just-want-the-m3u8-file-72',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-possible-to-access-in-depth-analytics-such-as-the-number-of-reconnections-drops-high-latency-and-live-metrics-73',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-the-100ms-live-stream-sdk-customisable-and-able-to-scale-to-millions-of-users-74',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-you-share-some-documentation-on-your-information-security-practices-75',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-ok-to-potentially-create-1000s-of-rooms-over-time-76',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-you-platform-handle-end-to-end-encryption-between-just-2-users-77',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#is-100ms-soc-2-complainant-78',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-teacher-handle-remote-users-student-screen-start-and-stop-like-remotely-muteunmute-of-av-79',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-get-data-on-how-many-users-are-online-80',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-i-can-specify-my-own-room_id-while-creating-a-room-81',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-mute-a-participant-using-a-serverside-api-82',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-disable-video-for-a-participant-using-a-serverside-api-83',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-can-i-handle-role-change-requests-on-my-backend-is-there-any-webhook-that-exists-or-is-planned-84',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-handle-role-change-requests-on-the-backend-such-as-through-a-webhook-or-api-85',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#just-want-to-know-that-if-we-create-role-with-api-and-want-changes-to-be-synced-in-react-sdk-so-that-we-can-use-that-role-86',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-the-functionality-of-disable-a-room-and-end-an-active-room-same-87',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-close-a-room-using-a-serverside-api-88',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-any-way-to-limit-participants-in-a-room-89',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#have-quieries-related-to-for-backend-we-need-apis-to-create-room-and-joining-people-to-it-and-for-websitefrontend-need-guidance-for-components-like-video-buttons-and-participants-etc-90',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-schedule-these-rooms-for-a-certain-date-and-time-and-send-invites-to-certain-email-ids-91',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-disable-room-by-id-in-document-it-says-name-should-be-the-input-server-side-doc-92',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#we-need-to-know-if-there-is-a-way-to-end-an-active-session-programmatically-reset-the-room-so-that-everyone-is-kicked-from-the-meeting-and-it-starts-a-new-session-93',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-you-explain-the-differences-between-the-hls-recording-and-beam-recording-webhook-events-94',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#for-incoming-webhooks-from-100ms-to-our-api-is-there-a-list-of-ips-that-can-be-whitelisted-95',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-an-api-call-we-can-make-to-set-the-webhook-url-and-headers-on-our-account-96',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#i-am-trying-to-get-the-data-from-a-webhook-but-i-am-not-receiving-anything-is-there-a-way-to-troubleshoot-this-issue-97',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#were-having-an-issue-with-the-beam-recorder-our-development-sites-are-through-a-vpn-do-you-have-any-known-ip-addresses-that-the-beam-recorder-will-be-coming-from-so-we-can-whitelist-it-98',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#do-you-have-some-static-ip-for-100ms-that-we-can-whitelist-your-hits-at-our-end-99',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#do-you-have-any-gcp-ip-range-assigned-to-your-gcp-workloads-from-where-you-would-write-files-100',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-is-the-filetypes-you-would-write-to-bucket-so-we-can-whitelist-them-101',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-does-pagination-between-tiles-affect-the-download-numbers-102',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#we-use-169-video-but-would-like-to-crop-it-to-something-like-149-in-the-jsreact-client-what-is-the-best-way-to-achieve-this-with-css-103',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-the-100ms-video-sdk-built-on-react-frontend-and-provide-group-call-functionality-104',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#do-we-provide-a-log-of-stats-for-nerds-105',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-does-a-host-differentiate-between-muting-the-remote-mic-so-that-nobody-can-hear-the-remote-vs-mute-the-remote-party-only-locally-so-that-others-can-still-hear-the-remote-106',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-add-the-feature-for-host-to-turn-the-guest-camera-on-mobile-to-face-front-107',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-play-a-static-video-as-a-participant-video-during-a-call-108',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-100ms-integrate-with-obs-studio-can-i-stream-from-obs-to-100ms-109',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-customise-the-width-and-height-of-video-tile-which-we-are-getting-from-usevideolist-hook-110',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-provision-developmenttesting-access-tokens-to-avoid-touching-production-datatemplates-in-development-and-staging-deploys-111',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-any-sandbox-mode-available-for-dev-environments-112',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-there-a-way-to-add-a-second-user-to-our-account-or-should-we-just-share-login-credentials-113',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-we-create-subaccount-in-existing-account-want-to-make-prod-and-non-prod-account-separate-114',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#could-you-specify-multiple-webhook-urls-for-different-environments-under-the-same-account-115',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-i-register-for-another-100ms-account-with-same-email-address-116',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-i-delete-rooms-via-dashboard-or-api-117',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-do-i-limit-the-session-to-a-specified-duration-118',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#how-do-i-record-a-room-119',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-do-i-debug-blank-video-tile-while-rendering-120',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#why-is-the-video-not-auto-playing-on-page-load-121',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#angular-why-is-video-not-auto-playing-even-though-muted-is-set-as-true-122',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-do-i-debug-no-audio-coming-in-the-room-123',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-possible-to-do-rtmp-out-live-stream-a-room-to-youtube-twitch-wowza-124',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-should-i-do-to-hide-the-beam-tile-showing-up-in-100ms-web-app-for-browser-based-recordingstreaming-125',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-do-i-make-the-beam-bot-join-with-a-custom-role-for-dashboard-web-app-126',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#why-does-youtube-dashboard-shows-that-the-video-bitrate-is-less-than-the-recommended-bitrate-when-using-rtmp-out-127',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#can-i-get-hls-out-for-a-room-128',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-do-i-join-an-api-created-room-from-dashboard-web-app-129',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#do-i-need-to-do-anything-to-handle-poor-internet-connection-130',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-i-store-extra-information-with-a-peer-131',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#how-do-i-implement-raise-hand-132',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#why-do-i-see-videos-getting-stuck-or-frozen-133',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#do-you-have-ui-components-134',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-i-use-the-sdk-with-nextjs-angular-svelte-vuejs-etc-135',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#i-want-to-suggest-a-new-feature-136',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#im-facing-an-issue-how-do-i-reach-out-137',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#can-i-create-room-using-api-138',
            ...
            },
            {
                ...
                objectID: '/docs/javascript/v2/foundation/faq#can-i-disable-a-room-139',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#is-it-possible-to-create-and-manage-roles-using-apis-140',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#does-the-sdk-remembers-inputoutput-device-selection-for-future-joins-141',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-i-implement-custom-events-to-broadcast-or-sent-to-a-specific-person-in-the-room-142',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-can-i-access-the-user-id-field-used-while-creating-the-token-after-joining-143',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-can-i-implement-break-out-rooms-144',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-i-locally-mute-a-remote-audio-track-145',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#can-i-process-video-before-sending-over-to-others-in-the-room-146',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-to-disable-console-logs-if-im-using-the-web-sdk-147',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#what-is-the-maximum-allowed-duration-for-a-session-148',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#how-can-i-get-the-hls-url-to-enable-live-stream-playback-149',
            ...
            },
            {
                ...
                objectID:
                    '/docs/javascript/v2/foundation/faq#i-get-type-errors-related-to-webrtc-stats-for-example-cannot-find-name-rtcinboundrtpstreamstats-150',
            ...
            },
            {
                ...
                objectID: '/docs/react-native/v2/foundation/faq#could-not-invoke-hmssdkbuild-151',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#trackid-is-undefined-hmsview-is-rendering-blank-view-152',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#unable-to-join-meeting-or-getting-error-on-join-preview-functions-of-hms-instance-153',
            ...
            },
            {
                ...
                objectID: '/docs/react-native/v2/foundation/faq#run-the-example-app-154',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#ui-components-to-test-all-the-features-and-functionalities-155',
            ...
            },
            {
                ...
                objectID: '/docs/react-native/v2/foundation/faq#customize-track-settings-156',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#to-customize-more-settings-other-than-defined-on-above-mentioned-classes-like-video-quality-aspect-ratio-screenshare-quality-157',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#bluetooth_connect-permission-errorwarning-158',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#using-hms-with-another-webrtc-library-159',
            ...
            {
                title: 'Expo Support',
                objectID: '/docs/react-native/v2/foundation/faq#expo-support-160',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#change-streaming-video-aspect-ratio-161',
            ...
            },
            {
                ...
                objectID: '/docs/react-native/v2/foundation/faq#how-to-get-hls-stream-url-162',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#video-player-to-play-hls-streams-163',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#how-to-muteunmute-specific-or-all-remote-peers-164',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#how-to-muteunmute-specific-or-all-remote-peers-only-locally-165',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#restrict-remote-peer-from-speaking-after-their-audio-is-muted-166',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#enable-pip-mode-automatically-when-user-leaves-app-167',
            ...
            },
            {
                ...
                objectID: '/docs/react-native/v2/foundation/faq#enable-pip-mode-in-ios-device-168',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#using-hmssdk-instance-in-nested-components-without-passing-as-props-169',
            ...
            },
            {
                ...
                objectID:
                    '/docs/react-native/v2/foundation/faq#how-many-hmsview-can-be-rendered-170',
            ...
            },
            {
                ...
                objectID: '/docs/flutter/v2/foundation/faq#flutter-version-compatibility-171',
            ...
            },
            {
                ...
                objectID:
                    '/docs/flutter/v2/foundation/faq#not-getting-event-updates-after-hot-reloadrestart-172',
            ...
            },
            {
                ...
                objectID:
                    '/docs/flutter/v2/foundation/faq#issues-while-using-hmssdk_flutter-with-flutter-30x-173',
            ...
            },
            {
                ...
                objectID:
                    '/docs/flutter/v2/foundation/faq#is-there-any-limit-to-the-number-of-hmsvideoview-on-screen-at-a-time-174',
            ...
            },
            {
                ...
                objectID:
                    '/docs/flutter/v2/foundation/faq#do-you-have-any-implementation-with-popular-state-management-libraries-175',
            ...
            },
            {
                ...
                objectID:
                    '/docs/flutter/v2/foundation/faq#not-able-to-get-room-updates-after-joining-the-room-176',
            ...
            },
            {
                ...
                objectID: '/docs/flutter/v2/foundation/faq#join-room-with-muted-audiovideo-177',
            ...
            },
            {
                ...
                objectID: '/docs/flutter/v2/foundation/faq#get-onpeerupdate-in-preview-178',
            ...
            },
            {
                ...
                objectID:
                    '/docs/flutter/v2/foundation/faq#getting-updates-multiple-times-in-the-room-179',
            ...
            },
            {
                ...
                objectID: '/docs/flutter/v2/foundation/faq#can-i-create-a-room-using-api-180',
            ...
            },
            {
                ...
                objectID: '/docs/flutter/v2/foundation/faq#receiving-too-many-logs-from-sdk-181',
            ...
            },
            {
                title: 'Do I need to do anything to handle poor internet connection?',
                objectID:
                    '/docs/flutter/v2/foundation/faq#do-i-need-to-do-anything-to-handle-poor-internet-connection-182',
            ...
            },
            {
                ...
                objectID:
                    '/docs/flutter/v2/foundation/faq#how-do-i-implement-raise-hand-polls-in-application-183',
            ...
            },
            {
                title: 'Why do I see videos getting stuck or frozen?',
                objectID:
                    '/docs/flutter/v2/foundation/faq#why-do-i-see-videos-getting-stuck-or-frozen-184',
            ...
            },
            {
                title: 'What is the maximum allowed duration for a session?',
                objectID:
                    '/docs/flutter/v2/foundation/faq#what-is-the-maximum-allowed-duration-for-a-session-185',
            ...
            {
                title: 'I want to suggest a new feature.',
                objectID: '/docs/flutter/v2/foundation/faq#i-want-to-suggest-a-new-feature-186',
