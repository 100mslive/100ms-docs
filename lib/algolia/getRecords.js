    ...
    if (appId && adminKey && algoliaIndex && projectENV === 'prod') {
        ...
        const faqs = [
            ...
            },
            {
                ...
                answers:
                    'You can get started with our video conferencing example to see a live demo. You can also clone the 100ms-web sample app to see how you can extend and customize as per your needs.\n\nMeanwhile, check our docs to explore information about various features and capabilities supported on the platform.'
            },
            {
                platform: 'Common',
                questions:
                ...
                answers:
                    'Yes, you can get started with one of our examples from here. You can also sign up for a 100ms account to access the dashboard.'
            },
            {
                platform: 'Common',
                questions:
                ...
                answers:
                    'You can start with our documentation. We also recommend checking out our GitHub for open source sample SDKs that can aid in initial integration; here is a piece on our live streaming capabilities.'
            },
            {
                platform: 'Common',
                questions:
            ...
            {
                platform: 'Common',
                questions: 'What is the difference between app token and management token?',
                answers:
            ...
            {
                platform: 'Common',
                questions: 'Is there an easy method to create an app token?',
                answers:
                    "Yes, you can get App tokens using a couple of approaches based on your app's lifecycle stage. Please check this guide for more information"
            },
            {
                platform: 'Common',
            ...
            },
            {
                ...
                answers:
                    "You can set up a token generation service on your end to create app tokens and block users that are trying to join without a token that's generated from your service. Please check authentication and tokens guide for more information.\n\nYou can update the code to point to your own token service (relevant code in the sample - see getToken(...)), your token endpoint can follow a similar interface: for a given room_id and role name, return the app token JWT.\n\nYou can continue using the existing routes (room_id/role) or set up your own routes in the cloned/forked code."
            },
            {
                platform: 'Common',
                questions: 'What is the difference between the Beam recording vs. SFU recording?',
                answers:
                    'Beam recording is the browser recording, built to give users a participant-first recording experience. SFU recording is a composite recording which gets created after recording each of the individual peers and merging it. Please check this guide for more information.'
            },
            {
                platform: 'Common',
                questions:
            ...
            },
            {
                ...
                answers:
                    'There are various webhook events associated with room, session, peers, recording and streaming. You can listen to these events and trigger the Stop a recording API when a specific event occurs.'
            },
            {
                platform: 'Common',
            ...
            },
            {
                ...
                answers:
                    'The 100ms RTMP streaming can be used with stream URLs from RTMP servers that allow RTMP streaming. For example, YouTube, Facebook, Instagram, Twitch, LinkedIn.'
            },
            {
                platform: 'Common',
                questions:
            ...
            },
            {
                ...
                answers:
                    'Currently, you can build additional interactive experiences in your app with the help of peer metadata. You can integrate features like raise hand, polls, quizzes, etc,. using this. You can also check the existing plugins on our platform such as collaborative whiteboard, virtual background, noise suppression, Custom audio & video plugins. Please stay tuned to our product updates by signing up for our newsletter from here.\n\nCurrently, you can build additional interactive experiences in your app with the help of Peer metadata. You can integrate raise hand, polls, quizzes, etc,. using this. You can also check the existing plugins our platform such as Virtual background, Noise suppression, Custom audio & video plugins. We will soon be adding a whiteboard plugin as well. Please stay tuned our product updates by signing up for our newsletter from here.\n\n'
            },
            {
                platform: 'Common',
                questions:
            ...
            },
            {
                ...
                answers:
                    'You can use end an active room API to end an ongoing session in a room. Optionally you can use the lock argument to disable the room future peer joins.'
            },
            {
                platform: 'Common',
