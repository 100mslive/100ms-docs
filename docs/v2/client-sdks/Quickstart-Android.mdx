...
The Activity takes the auth token out of the bundle and uses it to initialize the ViewModel.

```kotlin{13-21}:VideoCallActivity.kt
...
```kotlin{23-26}:VideoCallActivity.kt
...
```kotlin{28-30}:VideoCallActivity.kt
