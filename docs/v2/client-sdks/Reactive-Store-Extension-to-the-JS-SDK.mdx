...
Autoplay error will be thrown by browser if something is played without any user interaction. The sdk throws an error with code `3008` in the onError handler
