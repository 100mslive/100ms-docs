...
<div id='join-room-1' style={{ display: 'none' }}>
...
<divs id="data-room" items={['Joining Code', 'Full Code']} />{' '}
...
<div id='data-room-1' style={{ display: 'none' }}>
...
<div id='notif-1' style={{ display: 'none' }} >
...
// [See Documentation](/v2/error-codes/error-codes-and-description)
