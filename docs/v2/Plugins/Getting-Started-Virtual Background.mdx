...
<Image width={640} height={480} alt="VirtualBackground" src="/docs/v2/sample-room.png" />
...
// background : {'blur' | 'imgSource' | 'None'}
     ...
     // 'imgSource' -> image url , base64 or HTMLImageElement, set background to imgSource
