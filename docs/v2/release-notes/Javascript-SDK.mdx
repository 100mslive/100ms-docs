...
-   Changing roles mid-call. Refer Usage - [JavaScript SDK](../client-sdks/Getting-Started-Javascript#managing-roles) and [Reactive Store](../client-sdks/Reactive-Store-Extension-to-the-JS-SDK#managing-roles)
...
-   BREAKING CHANGE: For users of the [Reactive Store](../client-sdks/Reactive-Store-Extension-to-the-JS-SDK), the `HMSPeer` interface has been modified. Use `peer.roleName` instead of `peer.role` to obtain the name of a peer's role.
