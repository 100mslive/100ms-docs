...
## 0.0.124 - 2021-08-06
- Export `HMSLogLevel` to the HMSdk's log level.
...
- Autoplay handling added.
  ...
  - [JavaScript SDK](../client-sdks/Getting-Started-Javascript#handling-autoplay)
  - [React SDK](../web-frameworks/Getting-started-react#handling-autoplay)
  - [Reactive Store](../client-sdks/Reactive-Store-Extension-to-the-JS-SDK#handling-autoplay)
