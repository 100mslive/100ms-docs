...
- **Experimental** Automatic device change on plug/unplug.

> Use `track.setSettings` to override input devices. [Refer Usage](../client-sdks/Getting-Started-Javascript#changing-mic-camera-before-during-the-call)

> Use audio output manager(`hms.getAudioOutput().setDevice()` to override output devices. [Refer Usage](../client-sdks/Getting-Started-Javascript#managing-audio-ouput)
