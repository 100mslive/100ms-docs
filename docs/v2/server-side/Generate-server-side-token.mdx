...
var app_secret ='lfpt0lHMrBfJYiBFlEtReIgztywwY078SpaLGHIpieK89oN8kLDBzaMP7nxSGfS1ya-VT5CUiTRrILasqNKHnDDoBd8m3cCAhtCcPJpu8Nn1TCvC7fwwkygxO7u8MHxUmiEnbnN6tPAbJh7GQAJRKJyGikXcRlerj3EvEWX32hY=';
var app_access_key = '5f679ec41aa12942cde1c3c3';

jwt.sign({ access_key: app_access_key, type: 'management', version: 2 },
          app_secret,
...
def generate(expires=0):
    ...
    return jwt.encode(payload={"access_key": app_access_key,"type": "management","version": 2,"jti": str(uuid.uuid4()),"exp": exp,"iat": now,"nbf": now},key=app_secret).decode("utf-8")
