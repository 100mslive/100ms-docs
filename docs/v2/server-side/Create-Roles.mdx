...
A room can created by providing room name, description, recording flag and roles in the room.

<Image width={2524} height={1320} alt="Create a room" src="/docs/v2/sample-room.png" />

The roles you created in the previous section would appear here for selection. You can select the roles you want in your room.
