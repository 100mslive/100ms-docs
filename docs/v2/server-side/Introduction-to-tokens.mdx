...
100ms Access Tokens are based on the [JSON Web Token](http://jwt.io/) standard. You can read about the details of the JWT format for Access Tokens in this section, but if you're using \*\*\*\*our [quickstart app server guide](/v2/server-side/100ms-quickstart-app-server) you can skip this section
