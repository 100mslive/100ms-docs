...
<Image width={640} height={360} alt="VirtualBackground" src="/docs/v2/sample-vb.gif" />
...
16:9 aspect ratio is preferred else we are cropping the image to fit in background
