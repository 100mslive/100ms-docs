...
1. I use RPSystemBroadcastPickerView to show the screen share extension. But user sees a list of available broadcast extensions on along with my extension. How can I show only my extenstion to the user when they want to share the screen?

You can assign a preferredExtension to the instance of your RPSystemBroadcastPickerView so the system shown only your extension in the list:
...
Where live.100ms.videoapp.screenshare is the bundle id of your broadcast extension.
