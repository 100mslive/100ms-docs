...
To update the value of the session metadata for the current room session, use the **setSessionMetadata** method on SDK instance:
...
## Limitations and Alternatives in the Alpha Release
