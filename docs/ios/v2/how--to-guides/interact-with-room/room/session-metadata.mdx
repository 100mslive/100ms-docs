...
To update the value of the session metadata for the current room session, call **setSessionMetadata** method on SDK instance:

```swift
let hmsSDK = HMSSDK.build()
// Make sure you join the room using hmsSDK instance. You should listen to [onJoin()](https://www.100ms.live/docs/ios/v2/how--to-guides/set-up-video-conferencing/join#call-join) callback to proceed.
...
