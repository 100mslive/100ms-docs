...
With the information here, show a dialog to the user to ask if they want to accept the change and then apply the settings locally. The same as in a regular user [Mute/Unmute](https://www.100ms.live/docs/ios/v2/how--to-guides/set-up-video-conferencing/mute).
