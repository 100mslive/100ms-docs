...
If you want to modify camera settings like zoom level, flashlight, night-mode, HDR etc. you can use the camera control API to modify these settings.
...
100ms SDK provides you safe access to the current [AVCaptureDevice](https://developer.apple.com/documentation/avfoundation/avcapturedevice) object representing the camera being used on the iOS device, and you can modify the settings on this object.
