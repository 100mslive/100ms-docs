...
Checkout the HMSRoomModels SDK in detail on github: [https://github.com/100mslive/100ms-roomkit-models-ios](https://github.com/100mslive/100ms-roomkit-models-ios)
