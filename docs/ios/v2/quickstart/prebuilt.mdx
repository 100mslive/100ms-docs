...
## Pre-requisites
- _100ms account_: You need to have a 100ms account to create a room and get a [room-code](/docs/get-started/v2/get-started/prebuilt/room-codes/overview)/[auth-token](/docs/get-started/v2/get-started/security-and-tokens#auth-token-for-client-sdks). You can create a 100ms account [here](https://dashboard.100ms.live/signup).
- Xcode 14 or higher
- iOS 15 or higher
