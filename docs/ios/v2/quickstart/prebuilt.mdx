...
## ☝️ Pre-requisites
- _100ms account_: You need to have a 100ms account to create a room and get a room-code/auth-token. You can create a 100ms account [here](https://dashboard.100ms.live/signup).
- Xcode 14 or higher
- iOS 15 or higher
...
2. Open **HMSRoomKitDevelopmentProject** Xcode project inside **100ms-roomkit-ios** repository.
...
7. Once you are done, create PRs with your changes to **main branch** of **respective repositories**.
