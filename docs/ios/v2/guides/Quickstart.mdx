...
Create an instance of HMSSDK and store it in a variable
...
Build and launch on device, then join same room on web app to try a call between web and iOS. (Go to your room [Room in Dashboard](https://dashboard.100ms.live/rooms) and use one of the role url link for the web.)
