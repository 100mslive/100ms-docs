...
The `Client Apps` built using 100ms client SDKs require an `App Token` to join a room to initiate a video conferencing or live streaming session. Please check the [Authentication and Tokens guide](./../foundation/security-and-tokens)
