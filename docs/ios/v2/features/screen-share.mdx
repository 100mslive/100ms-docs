...
This is an issue if you use cocoapods for adding 100ms SDK and works fine if you are using swift package manager to add 100ms SDK. As a workaround please use a snippet similar to at the end of this example podfile to exclude arm64 arch for simulator from your pod screen share targrt:
