...
-   Your app need to have [com.apple.developer.avfoundation.multitasking-camera-access]([/docs/v2/screenshare-dashboard.png](https://developer.apple.com/documentation/bundleresources/entitlements/com_apple_developer_avfoundation_multitasking-camera-access)) entitlement to use PiP mode during video calls.
