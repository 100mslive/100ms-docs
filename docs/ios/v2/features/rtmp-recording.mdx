...
2. **rtmpURLs**: *[URL]?*. If streaming is required, this has to be one or more RTMP Injest Urls with max limit of 3 urls where the stream should go. If only recording, this should be nil.
