...
2. Custom Views: To use your own UI for HLS streaming, you need to provide your own webapp URL for our bot to join and stream.
...
#### Custom View
To use your own webapp UI for HLS, you'll need to pass in a meeting URL. The 100ms bot will open this URL to join your room, so
