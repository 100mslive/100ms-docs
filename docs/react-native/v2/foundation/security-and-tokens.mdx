...
App Token will be used by Client-side apps while instantiating 100ms' SDKs. It is used for joining the conference. The service required to generate this token should be hosted on your server. 
