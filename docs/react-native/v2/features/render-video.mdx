...
passed in HMSView you have to unmount the HMSView component and mount it with a new trackId, this can be done using a key prop and passing trackId as its value in the HMSView component.
```js
