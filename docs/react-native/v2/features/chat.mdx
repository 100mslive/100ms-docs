...
After [Joining the Room](./join), you can add a listener for `HMSUpdateListenerActions.ON_MESSAGE` event to receive new messages as `HMSMessage` object during the call.
