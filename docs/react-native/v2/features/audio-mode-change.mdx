...
This is android only API to change Audio Mode manually. The most common usecase would be toggle between (in-call volume/media volume) for in call volume [AudioManager.MODE_IN_COMMUNICATION] media volume [AudioManager.MODE_NORMAL]
