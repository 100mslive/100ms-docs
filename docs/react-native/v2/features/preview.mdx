...
> Note: To receive Room State in preview i.e. before joining the room, You can enable this feature in [Template](https://www.100ms.live/docs/react-native/v2/foundation/templates-and-roles) of the room. Refer [here]() for more
