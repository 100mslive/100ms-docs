...
![addCapability](/docs/guides/rn-background-service-2.png)

### Background Mode

Search Background Mode and add it to Project by clicking on it.

![backgroundMode](/docs/guides/rn-background-service-3.png)

### Enable Background Mode

Enable the checkbox under Background Modes named `Audio, AirPlay, and Picture in Picture`.

![backgroundProcessing](/docs/guides/rn-background-service-4.png)
