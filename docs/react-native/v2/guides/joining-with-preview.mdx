...
```js section=AttachingPreview sectionIndex=1
import HmsManager, { HMSUpdateListenerActions } from '@100mslive/react-native-hms';
...
```js section=CallingPreview sectionIndex=1
