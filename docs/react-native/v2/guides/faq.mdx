...
## Using HMS with Twilio & Agora

TODO: add more explanation here

App might crash or work unexpectedly.
...
## Update type TRACK_REMOVED received after TRACK_ADDED, When multiple Role change request is done for multiple Roles

TODO: Add Scinerio explanation and solution

You should do Multiple Role change request after some delay.
...
Picture in Picture (PIP) mode is not supported in iOS devices due to lack of permission of using [multitasking-camera-access](https://developer.apple.com/documentation/bundleresources/entitlements/com_apple_developer_avfoundation_multitasking-camera-access?language=objc#discussion) entitlement.
