...
Please check our [Basic Concepts Guide](../foundation/basics) to understand the concepts like Templates, Rooms, Peers, Roles, Tracks, etc.
...
![HMSSDK Integration Lifecycle](/docs/guides/rn-hmssdk-integration-lifecycle.png)
