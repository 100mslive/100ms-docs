...
4. Test run your app
    ...
    <Tab id="test-run-sample-app-0">
      ...
      ```bash tab=iOS
      // to run the app on iPhone 14 Simulator
    ...
    <Tab id="test-run-sample-app-1">
      ...
      ```bash tab=Android
      // to run the app on a Connected Android Device or any Emulator
    ...
    or follow Run instructions printed in Terminal to start the Metro Bundler.
