...
> Note: Don't build new `HMSSDK` instance before destroying the previous one. for more info checkout [here](../../install-the-sdk/hmssdk#what-does-destroy-method-do)