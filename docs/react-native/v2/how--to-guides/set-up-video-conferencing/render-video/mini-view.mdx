...
The 100ms React Native SDK provides the `HmsView` component, which renders video on the screen. You can refer to the [Render Video docs](../features/render-video) to learn more about the `HmsView` component.
