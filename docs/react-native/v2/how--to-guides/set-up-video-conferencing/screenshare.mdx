...
### iOS Screenshare should show only my app's Screenshare Extension name when starting Screenshare
...
Your `preferredExtension` name in Xcode under Signing and Capabilities section under Target > yourExtensionName.
