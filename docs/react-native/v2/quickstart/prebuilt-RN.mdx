...
```bash
npm install @100mslive/react-native-hms @shopify/flash-list@1.4.3 react-native-avoid-softinput@2.4.8 react-native-linear-gradient@2.7.3 react-native-modal@12.1.0 react-native-safe-area-context@3.3.0 react-native-simple-toast@1.1.3
```
