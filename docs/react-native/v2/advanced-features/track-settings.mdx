...
- `initialState`
  ...
  For more info about Muting and Unmuting Audio Track, check out [Mute and Unmute](../features/mute) docs.
...
- `initialState`
  ...
  For more info about Muting and Unmuting Video Track, check out [Mute and Unmute](../features/mute) docs.
