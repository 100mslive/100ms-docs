...
- `initialState`
  ...
  Property to set the initial state of the Audio track i.e. Mute/Unmute. You can use `HMSTrackSettingsInitState` enum to set this value.
  
  More info about this can be found in [Mute and Unmute](../features/mute) docs.
...
- `initialState`
  ...
  Property to set the initial state of the Video track i.e Mute/Unmute. You can use `HMSTrackSettingsInitState` enum to set this value.
