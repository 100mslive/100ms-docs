...
2. _type_[optional]: The type (`string`) of the message, default value is `chat`.
...
3. _type_[optional]: The type (`string`) of the message, default value is `chat`.
...
-   _type_: The type (`string`) of the message. Default value is `chat`.
