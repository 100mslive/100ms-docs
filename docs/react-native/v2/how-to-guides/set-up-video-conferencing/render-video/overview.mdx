...
We have used `PeerTrackNode` object type in our [Quickstart Sample app](https://github.com/100mslive/react-native-hms/tree/develop/sample-apps/) and [Example app](https://github.com/100mslive/100ms-react-native/tree/main/packages/react-native-hms/example). A detailed explanation of our Example App & multiple UI components are [available here](https://github.com/100mslive/100ms-react-native/tree/main/packages/react-native-hms/example#peertracknodes).
...
-   Checkout our Example App UI implementation [available here](https://github.com/100mslive/100ms-react-native/tree/main/packages/react-native-hms/example).
