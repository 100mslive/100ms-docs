...
interface HMSRtmpStreamingState {
    ...
    state: HMSStreamingState; // indicates the current state of RTMP Streaming
}
```
...
interface HMSBrowserRecordingState {
    ...
    state: HMSRecordingState; // indicates the current state of Browser Recording
}
```
...
interface HMSServerRecordingState {
    ...
    state: HMSRecordingState; // indicates the current state of Server Recording
}
```
