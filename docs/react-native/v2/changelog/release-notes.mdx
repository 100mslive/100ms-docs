...
- On Android, incremented the `compileSdkVersion` & `targetSdkVersion` to `31`. For the changes in `build.gradle` file, refer [here](https://github.com/100mslive/react-native-hms/pull/1064/files#diff-197b190e4a3512994d2cebed8aff5479ff88e136b8cc7a4b148ec9c3945bd65a).
