...
<<<<<<< HEAD:docs/android/v2/features/change-role.mdx
...
=======
Role is a powerful concept that takes a lot of complexity away in handling permissions and supporting features like breakout rooms. [Learn more about roles here.](/android/v2/foundation/templates-and-roles)
>>>>>>> main:docs/android/v2/how--to-guides/interact-with-room/interact-with-peer/change-role.mdx
