...
Android SDK provides support for creating Picture in Picture mode experience for video calls.
...
2. Pip mode resized you whole activity to a small conatiner. Inorder to show elements in PiP you would like to hide the visibility of views you don't want to show.
