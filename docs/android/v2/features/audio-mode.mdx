...
nav: 13
---
API to change Audio Mode manually. The most common use-case would be toggle between (in-call volume/media volume) for in call volume [AudioManager.MODE_IN_COMMUNICATION] media volume [AudioManager.MODE_NORMAL]
