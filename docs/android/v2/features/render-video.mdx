...
HMSVideoView has an automatic simulcast layer selection capability which is enabled if adaptive bitrate is enabled. You can check more about it [here](https://www.100ms.live/docs/ios/v2/foundation/adaptive-bitrate) 
