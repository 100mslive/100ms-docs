...
```
Also remember to disable `auto re-size` option in `HMSVideoTrackSettings` before doing this as described [here](https://www.100ms.live/docs/android/v2/advanced-features/track-settings#disableautoresize).
