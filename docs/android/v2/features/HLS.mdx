...
2. Custom Views: To use your own UI for HLS, you would need a custom implementation of the browser that joins to stream it. Provide your own URLs for it to join.
