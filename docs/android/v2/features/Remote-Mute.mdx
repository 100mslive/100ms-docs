...
For single peer/track look at [single peer /track](#single-peer-or-track).

For multiple peer/track muting simultaneously look at [Multiple peers or tracks](#multiple-peers-or-tracks)
