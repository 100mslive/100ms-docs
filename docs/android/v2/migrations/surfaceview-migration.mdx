...
HMSVideoView provides a better abstaraction to render live video, comes with additionaly features like zoom and pan, auto-bitrate adjuster on the playback side.
