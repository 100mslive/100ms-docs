...
Min api version for the virtual background plugin is 21. Same as the min api version core sdk for 100ms. The lowest SDK version it can work with is 21. It is built for armeabi-v7a, arm64-v8a, x86, and x86_64 architectures.
