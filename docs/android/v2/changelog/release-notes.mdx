...
##v2.7.7-alpha - 2023-09-15
### Added
- Support for very large rooms
- First class APIs to raise/lower hand of local/remote peer
- `isHandRaised` property in `HMSPeer`
- `HAND_RAISE_CHANGED` type in `HMSPeerUpdate`
- `onPeerListUpdated` callback in `HMSUpdateListener` - This will be called whenever there is change detected in peerlist
