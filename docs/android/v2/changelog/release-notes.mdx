...
### Added
- Polls: Polls are now native to 100ms! Start quizzes or run a poll to get everyone's opinions. [Read the docs](../android/v2/how-to-guides/interact-with-room/room/polls)
