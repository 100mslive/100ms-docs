...
-   _Room-code_: Prebuilt components require a `room-code` to join a room. You can get a `room-code` for a room using the 100ms dashboard. Refer to [this](/get-started/v2/get-started/prebuilt/room-codes/overview) guide to learn more about room-codes.
