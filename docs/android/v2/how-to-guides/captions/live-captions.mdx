...
Live transcripts can also be toggled on and off with:

1. `HMSSDK.startRealTimeTranscription(mode : TranscriptionsMode, listener : HMSActionResultListener)`
2. `HMSSDK.stopRealTimeTranscription(mode : TranscriptionsMode, listener : HMSActionResultListener)`
