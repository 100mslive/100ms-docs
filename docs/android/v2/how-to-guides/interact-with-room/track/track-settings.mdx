...
This seeting is used to enable disable sdk's audio manager, On disabling audio manager the app developer takes in responsibilty of manging audio routes
