...
Blur filter plugin helps in blurring the background of a video frame.
This guide provides an overview of the 100ms Blur Filter plugin.


## Supported Versions/Resolutions

-   Minimum 100ms SDK version required is `2.9.56`
