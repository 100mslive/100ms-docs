...
To use the diagnostic apis first you need to get an instance of `HMSDiagnostic` from the `HMSSDK` instance.
<Tab id='instantiate-HMSDiagnostic'>
...
```kotlin
            ...
            val diagnosticSDK =  hmsSDK.getDiagnosticSDK("user-id")
...
<Tab id='HMSDiagnostic-checkMicrophone'>
...
<Tab id='HMSDiagnostic-stopMicCheck'>
...
<Tab id='HMSDiagnostic-startSpeakerCheck'>
...
<Tab id='HMSDiagnostic-stopSpeakerCheck'>
...
<Tab id='HMSDiagnostic-startCameraCheck'>

```kotlin
            // get the diagnostic instance
            val diagnosticSDK =  hmsSDK.getDiagnosticSDK("user-id")

            diagnosticSDK.startCameraCheck(HMSVideoTrackSettings.CameraFacing.FRONT,
...
<Tab id='HMSDiagnostic-startConnectivityCheck'>
...
<Tab id='HMSDiagnostic-ConnectivityState'>
...
| Name                 | Description                                                                                                                                 |
| -------------------- | --------------------------------------------------------------------
| `testTimestamp`      | timestamp in millis when the test was conducted
...
In the stats, SDK reports the following stats for both audio and video seperately in the `stats` field of `MediaServerReport`
| Name                  | Description
| --------------------- | --------------------------------------------------------------------
