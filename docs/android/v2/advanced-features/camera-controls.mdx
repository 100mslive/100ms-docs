...
To ues the camera controls, you can use `CameraControl` class to access it's functionality.
...
cameraControl.captureMaxResolutionImage(
    savePath: File, 
...
val gestureDetector = GestureDetectorCompat(context, object : GestureDetector.SimpleOnGestureListener() {
    ...
    override fun onDoubleTap(e: MotionEvent): Boolean {
        ...
        cameraControl.captureMaxResolutionImage(imageSavePath) { isSuccess ->
