...
```bash
curl https://api.100ms.live/v2/rooms?id=<id> -H 'Authorization: Bearer  <management_token>' -X POST -H 'Content-Type: application/json' -d '{"enabled": false}'
```
