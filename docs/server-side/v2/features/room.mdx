...
Room is a virtual space which holds conferencing of the people. To allow users to join a 100mssss video conferencing session inside your app, you first need to create a `room`.
