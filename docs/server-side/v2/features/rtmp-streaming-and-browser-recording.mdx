...
| rtmp_urls <br/>   | `array`  | List of RTMP output urls to which the meeting will be streamed. <br/> Required when RTMP streaming needs to be started. <br/> Supports `rtmp://` only      | No       |
