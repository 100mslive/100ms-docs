...
| Name              | Type     | Description                                                                                                | Required |
| :---------------- | :------- | :--------------------------------------------------------------------------------------------------------- | :------- |
| width <br/>       | `int`    | Width of the video. <br/> Range: `500`-`1920`. If width>1920 then max width=1920. <br/>Default: `1280`     | Yes      |
| height <br/>      | `int`    | Height of the video. <br/> Range: `480`-`1080`. If height>1080 then max height=1080. <br/>Default: `720`   | Yes      |
