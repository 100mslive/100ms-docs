...
Please check below to understand how these params are useful while starting RTMP streaming or browser recording using 100ms app links:
...
-   `auth_token=token1234`: Use this to pass auth token generated on your side to the recording web-app
...
<Content alias="rtmpExternalConfig" />
