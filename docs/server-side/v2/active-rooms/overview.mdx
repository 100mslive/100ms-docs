...
-   To build real-time interactivity, like [updating a custom avatar](/server-side/v2/active-rooms/update-a-peer#scenario2-custom-avatar) in the video tile, [virtual poker handler](/server-side/v2/active-rooms/update-a-peer#scenario1-poker-handler) for a multiplayer game, and more.
