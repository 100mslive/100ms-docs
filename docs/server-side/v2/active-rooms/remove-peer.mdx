...
-   If you wish to disconnect a particular peer from an active room and block them for upcoming joins due to some misconduct(abusive chat), you can leverage this API. You can build a custom logic at your end to not generate an app token for the specific user for upcoming join requests.
