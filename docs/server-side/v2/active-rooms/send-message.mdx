...
-   For example, Suppose a teacher cannot attend a virtual classroom session at the last minute. In that case, you can inform all the connected peers(students) by sending a broadcast message to inform the teacher's unavailability.
