...
| frameRate | `int`    | Max number of screen frames per second<br/>Range: 1-10<br/>Default: 10   | No       |
...
| Name   | Type    | Description                    | Required |
| :----- | :------ | :----------------------------- | :------- |
| height | `int`   | Max height of the video track. | No       |
| width  | `int`   | Max width of the video track.  | No       |
| layers | `array` | See json below.                | No       |
...
| Name   | Type    | Description                 | Required |
| :----- | :------ | :-------------------------- | :------- |
| height | `int`   | Height of the screen track. | No       |
| width  | `int`   | Width of the screen track.  | No       |
| layers | `array` | See json below.             | No       |
...
| lockRoom        | `boolean` | Permission to lock a room.                         | No       |
...
| Name   | Type     | Description                                                                                                             | Required |
| :----- | :------- | :---------------------------------------------------------------------------------------------------------------------- | :------- |
| region | `string` | Region in which the room will be hosted by default ["auto"/"in"/"us"/"eu"] - "auto" implies automatic region selection. | No       |
...
| Name         | Type     | Description                                                          | Required |
| :----------- | :------- | :------------------------------------------------------------------- | :------- |
| region <br/> | `string` | Region in which the room will be hosted by default ["in"/"us"/"eu"]. | No       |
...
<GetRequest
    title="/api/v1/settings/:id/settings"
