...
| session    | `string`     | 100ms assigned id to identify the session                                    | 5f9edc6bd238215aec7700df             |
...
| metadata_timestamp | `string`     | Webhook message creation timestamp                 | 2020-11-11T17:32:17Z                 |
| start_delay        | `number`     | Time taken by beam to start recording              | 12                                   |
| state_name         | `string`     | Beam state identifier                              | Started                              |
| state_timestamp    | `string`     | Timestamp at which beam state changed              | 2020-11-11T17:32:18Z                 |
...
| metadata_id        | `string`     | Webhook metadata ID                                | 14f350f5-18c4-46ca-8a33-71cbcc836600 |
| metadata_timestamp | `string`     | Webhook message creation timestamp                 | 2020-11-11T17:32:17Z                 |
| created_at         | `string`     | Beam recording file when created                   | 2020-11-11T17:12:17Z                 |
...
| started_at         | `string`     | Beam recording started at                          | 2020-11-11T17:12:27Z                 |
| stopped_at         | `string`     | Beam recording stopped at                          | 2020-11-11T17:32:15Z                 |
...
| started_at         | `string`     | Timestamp at which hls started                     | 2020-11-11T17:32:18Z                 |
...
| started_at         | `string`     | Timestamp at which hls started                     | 2020-11-11T17:32:18Z                 |
| stopped_at         | `string`     | Timestamp at which hls stopped                     | 2020-11-11T17:32:18Z                 |
