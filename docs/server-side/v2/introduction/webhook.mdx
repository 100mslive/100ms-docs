...
This event will be sent if failure happens while peer changes role. This can occur when,

1. Peer tries to change role to a particular role whose peer limit has already reached.
