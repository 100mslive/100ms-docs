...
| timestamp   | `timestamp (in UTC)` | Timestamp of the event                                              | 2020-11-11T16:32:17Z                 |
...
| template_id        | `string`             | Template ID of the room                   | 66112497abcd52312556c4gg |
| session_started_at | `timestamp (in UTC)` | Timestamp when session started            | 2020-11-11T16:32:17Z     |
...
| template_id        | `string`             | Template ID of the room                   | 66112497abcd52312556c4gg |
| session_started_at | `timestamp (in UTC)` | Timestamp when session started            | 2020-11-11T16:32:17Z     |
| session_stopped_at | `timestamp (in UTC)` | Timestamp when session ended              | 2020-11-11T16:32:17Z     |
...
| joined_at          | `timestamp (in UTC)` | Timestamp when user joined                     | 2020-11-11T16:32:17Z                 |
| session_started_at | `timestamp (in UTC)` | Timestamp when session started                 | 2020-11-11T16:32:17Z                 |
...
| left_at            | `timestamp (in UTC)` | Timestamp when user left                            | 2020-11-11T17:32:17Z                 |
...
| Name                                         | Description                                                                                             |
| :------------------------------------------- | :------------------------------------------------------------------------------------------------------ |
| beam_id <br/>`string`                        | Unique beam id <br/><br/> Example: 61d3def54b616982bd80ed83                                             |
| job_id <br/>`string`                         | Beam job id <br/><br/> Example: 60b8e1d96eb86d8101b57359                                                |
| room_id <br/>`string`                        | 100ms assigned room id <br/><br/> Example: 5f9edc6ac238215aec2312df                                     |
| peer_id <br/>`string`                        | 100ms assigned id to identify the joining user <br/><br/> Example: bd0c76fd-1ab1-4d7d-ab8d-bbfa74b620c4 |
| session_id <br/>`string`                     | 100ms assigned id to identify the session <br/><br/> Example: 5f9edc6bd238215aec7700df                  |
| metadata_id <br/>`string`                    | Webhook metadata ID <br/><br/> Example: 14f350f5-18c4-46ca-8a33-71cbcc836600                            |
| template_id <br/>`string`                    | Template ID of the room <br/><br/> Example: 66112497abcd52312556c4gg                                    |
| metadata_timestamp <br/>`timestamp (in UTC)` | Webhook message creation timestamp <br/><br/> Example: 2020-11-11T17:32:17Z                             |
| start_delay <br/>`number`                    | Time taken by beam to start recording <br/><br/> Example: 12                                            |
| state_name <br/>`string`                     | Beam state identifier <br/><br/> Example: Started                                                       |
| state_timestamp <br/>`timestamp (in UTC)`    | Timestamp at which beam state changed <br/><br/> Example: 2020-11-11T17:32:18Z                          |
| meeting_url <br/>`string`                    | meeting_url provided at rtmp start <br/><br/> Example: "https://app.100ms.live/room_id"                 |
| rtmp <br/>`array`                            | List of RTMP objects provided at rtmp start <br/><br/> Example: [{"url": "http://test.com"}]            |
| session_started_at <br/>`timestamp (in UTC)` | Timestamp when session started <br/><br/> Example: 2020-11-11T16:32:17Z                                 |
...
| template_id        | `string`             | Template ID of the room                                                    | 66112497abcd52312556c4gg             |
| metadata_timestamp | `timestamp (in UTC)` | Webhook message creation timestamp                                         | 2020-11-11T17:32:17Z                 |
| state_name         | `string`             | Beam state identifier                                                      | Stopped                              |
| state_timestamp    | `timestamp (in UTC)` | Timestamp at which beam state changed                                      | 2020-11-11T17:32:18Z                 |
| duration           | `number`             | Duration of RTMP streaming / recording in seconds                          | 12                                   |
| max_width          | `int`                | Maximum width of the screen supported for streaming / recording in pixels  | 1280                                 |
| max_height         | `int`                | Maximum height of the screen supported for streaming / recording in pixels | 720                                  |
...
| session_id         | `string`             | 100ms assigned id to identify the session                      | 5f9edc6bd238215aec7700df             |
| template_id        | `string`             | Template ID of the room                                        | 66112497abcd52312556c4gg             |
| created_at         | `timestamp (in UTC)` | Timestamp at which recording was created                       | 2020-11-11T17:12:17Z                 |
...
| started_at         | `timestamp (in UTC)` | Beam recording started at                                      | 2020-11-11T17:12:27Z                 |
| stopped_at         | `timestamp (in UTC)` | Beam recording stopped at                                      | 2020-11-11T17:32:15Z                 |
| max_width          | `int`                | Maximum width of the screen supported for recording in pixels  | 1280                                 |
| max_height         | `int`                | Maximum height of the screen supported for recording in pixels | 720                                  |
| meeting_url        | `string`             | meeting_url provided at rtmp start                             | "https://app.100ms.live/room_id"     |
| rtmp               | `array`              | List of RTMP objects provided at rtmp start                    | [{"url": "http://test.com"}]         |
| session_started_at | `timestamp (in UTC)` | Timestamp when session started                                 | 2020-11-11T16:32:17Z                 |
...
| metadata_id        | `string`             | Webhook metadata ID                                                        | 14f350f5-18c4-46ca-8a33-71cbcc836600 |
| metadata_timestamp | `timestamp (in UTC)` | Webhook message creation timestamp                                         | 2020-11-11T17:32:17Z                 |
| state_name         | `string`             | Beam state identifier                                                      | Failed                               |
| state_timestamp    | `timestamp (in UTC)` | Timestamp at which beam state changed                                      | 2020-11-11T17:32:18Z                 |
| duration           | `number`             | Duration of RTMP streaming / recording in seconds                          | 12                                   |
| max_width          | `int`                | Maximum width of the screen supported for streaming / recording in pixels  | 1280                                 |
| max_height         | `int`                | Maximum height of the screen supported for streaming / recording in pixels | 720                                  |
...
| started_at         | `timestamp (in UTC)` | Timestamp at which HLS started                 | 2020-11-11T17:32:18Z                 |
| session_started_at | `timestamp (in UTC)` | Timestamp when session started                 | 2020-11-11T16:32:17Z                 |
...
| session_id         | `string`             | 100ms assigned id to identify the session                                      | 5f9edc6bd238215aec7700df             |
| template_id        | `string`             | Template ID of the room                                                        | 66112497abcd52312556c4gg             |
| max_width          | `int`                | Maximum width of the screen supported for HLS streaming / recording in pixels  | 1280                                 |
| max_height         | `int`                | Maximum height of the screen supported for HLS streaming / recording in pixels | 720                                  |
| meeting_url        | `string`             | meeting_url provided at HLS start                                              | "https://app.100ms.live/room_id"     |
| metadata_id        | `string`             | Webhook metadata ID                                                            | 14f350f5-18c4-46ca-8a33-71cbcc836600 |
| metadata_timestamp | `timestamp (in UTC)` | Webhook message creation timestamp                                             | 2020-11-11T17:32:17Z                 |
...
| started_at         | `timestamp (in UTC)` | Timestamp at which HLS started                                                 | 2020-11-11T17:32:18Z                 |
| stopped_at         | `timestamp (in UTC)` | Timestamp at which HLS stopped                                                 | 2020-11-11T17:32:18Z                 |
| session_started_at | `timestamp (in UTC)` | Timestamp when session started                                                 | 2020-11-11T16:32:17Z                 |
...
| meeting_url        | `string`             | meeting_url provided at HLS start                                              | "https://app.100ms.live/room_id"     |
| error_code         | `number`             | Beam error code                                                                | 1                                    |
| error_message      | `string`             | Beam error message (description)                                               | Beam failed with unknown error       |
| error_type         | `string`             | Beam error type                                                                | BeamFailed                           |
| metadata_id        | `string`             | Webhook metadata ID                                                            | 14f350f5-18c4-46ca-8a33-71cbcc836600 |
| metadata_timestamp | `timestamp (in UTC)` | Webhook message creation timestamp                                             | 2020-11-11T17:32:17Z                 |
| state_name         | `string`             | Beam state identifier                                                          | HLSFailed                            |
| state_timestamp    | `timestamp (in UTC)` | Timestamp at which beam state changed                                          | 2020-11-11T17:32:18Z                 |
| duration           | `number`             | Duration of HLS streaming in seconds                                           | 12                                   |
| session_started_at | `timestamp (in UTC)` | Timestamp when session started                                                 | 2020-11-11T16:32:17Z                 |
...
| metadata_id                         | `string`             | Webhook metadata ID                                                         | 14f350f5-18c4-46ca-8a33-71cbcc836600 |
| metadata_timestamp                  | `timestamp (in UTC)` | Webhook message creation timestamp                                          | 2020-11-11T17:32:17Z                 |
| duration                            | `number`             | Duration of HLS recording in seconds                                        | 12                                   |
| session_id                          | `string`             | 100ms assigned id to identify the session                                   | 5f9edc6bd238215aec7700df             |
| template_id                         | `string`             | Template ID of the room                                                     | 66112497abcd52312556c4gg             |
| max_width                           | `int`                | Maximum width of the screen supported for HLS recording in pixels           | 1280                                 |
| max_height                          | `int`                | Maximum height of the screen supported for HLS recording in pixels          | 720                                  |
| meeting_url                         | `string`             | meeting_url provided at HLS start                                           | "https://app.100ms.live/room_id"     |
| recording_created_at                | `timestamp (in UTC)` | Timestamp at which recording was created                                    | 2020-11-11T17:12:17Z                 |
| started_at                          | `timestamp (in UTC)` | Timestamp at which HLS started                                              | 2020-11-11T17:32:18Z                 |
| stopped_at                          | `timestamp (in UTC)` | Timestamp at which HLS stopped                                              | 2020-11-11T17:32:18Z                 |
