...
-   For example, if you're using our [sample app](https://github.com/100mslive/100ms-web), you can copy-paste the token endpoint from your 100ms dashboard into the [.env configuration](https://github.com/100mslive/100ms-web/blob/main/example.env) (REACT_APP_TOKEN_GENERATION_ENDPOINT).
