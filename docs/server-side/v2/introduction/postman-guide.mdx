...
2. Name your Environment (e.g., Dev Env) and add two variables `APP_ACCESS_KEY` and `APP_SECRET`.
...
5. Similarly, you create other environments (e.g., QA and Production) for different workspaces to maintain ease of authentication access.
