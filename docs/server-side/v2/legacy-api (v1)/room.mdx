...
> **Note**: We recommend you use our [new API (V2)](/server-side/v2/Rooms/object) to leverage the new functionalities and features and stay up to date with future releases. <br/> <br/>The Legacy API (V1 will remain fully functional until the subsequent notice. Currently, there's no end of life for them.
