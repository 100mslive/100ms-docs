...
| modes            | `array`  | Array of modes for transcription. Valid values: [ `recorded`, `live`, `caption` ] <br/> (recorded: Transcribe recording post call completion, live: Closed caption for live stream viewers, caption: Real-time closed captions) | No       |
