...
| enableZipUpload    | `boolean` | By default, the value is 'false'. You can set this to 'true' if the recording storage is your personal storage bucket and `upload` [object](#upload-object) is configured. Setting it to 'true' without that will give an error.                                                                                                                                              | No       |
