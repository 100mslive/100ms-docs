...
| webhook <br/>       | `object`  | Object of type `webhook`. This object contains webhook information like url, headers and an active flag to enable or disable the webhook. <br/><br/>Check the [webhook arguments](#webhook-arguments) below for more information.                                                                                                                        | No       |
...
| active      | `boolean`  | Enable this for receiving webhooks on the above URL. Default is false.   | No       |
