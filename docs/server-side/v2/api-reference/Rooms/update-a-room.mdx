...
| webhook <br/>       | `object`  | Object of type `webhook`. This object contains webhook information like url and headers. <br/>Check the [webhook arguments](/server-side/v2/Rooms/create-via-api#webhook-arguments) for more information.                                                                                                                        | No       |
