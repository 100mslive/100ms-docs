...
| webhook <br/>       | `object`  | Object of type `webhook`. This object contains webhook information like url, headers and an active flag to enable or disable the webhook. <br/><br/>Check the [webhook arguments](/server-side/v2/Rooms/create-via-api#webhook-arguments) below for more information.                                                                                                                        | No       |
