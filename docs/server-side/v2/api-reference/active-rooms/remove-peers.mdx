...
-   Use this API to remove a peer from an active room for misconduct (for example, abusive chat). This can be combined with custom logic not to generate auth tokens for this user to block them from future joins.
