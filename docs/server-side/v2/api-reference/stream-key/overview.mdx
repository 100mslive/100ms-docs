...
Use stream keys and RTMP URL to ingest RTMP-encoded media from a broadcasting software (for example - OBS Studio), transcode it into an HLS stream, and play it in a 100ms room.
