...
> Note: This API does not return the list of recording assets to optimize for performance. To fetch the list of assets for a recording job, use the [get recording API](./get-recording).
