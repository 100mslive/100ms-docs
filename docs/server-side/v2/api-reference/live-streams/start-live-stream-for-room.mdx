...
| modes             | `array`   | Array of modes for transcription. Valid values: [ `recorded`, `live` ] (recorded: Transcribe recording post call, live: Closed caption for live stream viewers) | No       |
