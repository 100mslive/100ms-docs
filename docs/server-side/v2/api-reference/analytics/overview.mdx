...
Analytics Events APIs are used to fetch events with an HTTP request. Currently, we support retrieving [track](/server-side/v2/api-reference/analytics/track-events)
and [recording](/server-side/v2/api-reference/analytics/recording-events) events.
