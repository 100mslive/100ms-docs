...
Analytics events APIs can be used to fetch the recording events similar to [webhook](/server-side/v2/how--to-guides/configure-webhooks/webhook#beamrecordingsuccess)
