...
* `room-vod`: This is also a composition of all peers in the room and is available in HLS (or m3u8) format for on-demand playback. Based on your chosen recording storage option (100ms hosted or your storage bucket), you have the option to export this file in a zipped or un-zipped format. You can [learn more about this here](/get-started/v2/get-started/features/recordings/stream-recording). 
