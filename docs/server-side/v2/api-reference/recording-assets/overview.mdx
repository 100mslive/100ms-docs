...
* `transcript`: This type is composed of generated transcripts of the recording, if transcription was enabled. The metadata will contain the `output_mode` (`txt`, `srt`, `json`) of the transcript.
* `summary`: This type contains the summary generated from the transcript. The metadata will contain the `output_mode` (`json`) of the summary.
...
| output_mode | Under `metadata`, file format of the generated transcript and summary (`txt`, `srt`, `json`)                   |
