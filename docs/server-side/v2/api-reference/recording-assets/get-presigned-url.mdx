...
> - CDN URL which you can put in any compatible player to play the VOD file if the recording storage is 100ms' and the VOD upload format in 'unzipped'.
...
> <br/>
> Learn more about VOD on 100ms [here](/get-started/v2/get-started/features/recordings/live-stream-recording#video-on-demand-vod-recording-m3u8).
