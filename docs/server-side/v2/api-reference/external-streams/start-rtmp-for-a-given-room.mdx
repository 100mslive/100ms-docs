---
title: Start RTMP Streaming and / or recording for a given room
nav: 3.19
---

Trigger this request to start rtmp streaming and / or recording .

<PostRequest title="https://api.100ms.live/v2/external-streams/rooms/:room_id/start" />
<Request id="req-0">

```bash
curl --location --request POST 'https://api.100ms.live/v2/external-streams/<room_id>/start' \
