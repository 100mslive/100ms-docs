...
External streams can be optionally recorded by passing a boolean flag. This generates a `composite-room` [recording asset](../recording-assets/overview) at the end of the external stream.
