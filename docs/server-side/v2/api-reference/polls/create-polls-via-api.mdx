---
title: Create/Update polls via API
nav: 3.81
---
...
A recommended way to create a poll is to provide a list of questions while [creating poll](/server-side/v2/api-reference/polls/create-polls-via-api), then update those questions by modifying them using [update question](/server-side/v2/api-reference/polls/update-polls-question-via-api)/[delete question](/server-side/v2/api-reference/polls/delete-polls-question-via-api) or update/delete opions API.
