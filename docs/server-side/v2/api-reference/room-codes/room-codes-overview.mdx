...
Room codes are unique encrypted short codes that carry information such as room_id and role. A Room Code is always associated to specific to a role and room_id combination.
