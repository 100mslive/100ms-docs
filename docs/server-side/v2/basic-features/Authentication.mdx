...
`app_access_key` and `app_secret` is required to generated the tokens. You can get it from the [Developer](https://dashboard.100ms.live/developer) section of [100ms Dashboard](https://dashboard.100ms.live/)​
...
$issuedAt  = new DateTimeImmutable();
$expire    = $issuedAt->modify('+24 hours')->getTimestamp();
$accessKey = "5ff5881b80b66969e1fb35f7";
$secret = "afd0IdxQyHobYPmAylVUEMKyenZCcRyMSKbWJmgjg5cOA7AoFO5MPLoUcBtozUWqvZn-E4Dt1OXK2s3L0qTl5jkEeNl3ezxk6_IeQsCP_DHdo2opcas3z1R2LrcJHJtU81gjPj8b-14PcdbTlX4vCE1Rxt6tqh5AWvOSqIzmOqc=";
$version   = 2;
$type      = "app";
$role      = "host";
$roomId    = "610abd0755daa6cd3eb57198";
$userId    = "5fc62c5872909272bf9995e1";
