...
Retrieves the details of a specific session. 100ms provides options to retrieve details of a session with their ID or room ID.
...
| room_id <br/> — query param | `string` | Unique identifier of the room you wish to fetch session details for. <br/><br/>**Example**: 627ce5b8f2e4e30487862adb | No       |
