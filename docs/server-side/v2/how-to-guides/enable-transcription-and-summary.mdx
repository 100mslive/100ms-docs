...
The above flowchart shows the entire process 
...
![Transcription-config](/docs/v2/transcription-dashboard-config.gif)
...
>		    "custom_vocabulary": [100ms],
>		    "summary": {
>			     "enabled": true,
>			     "context": "",
>			     "sections": [ 
>				      { "title": "Agenda", "format": "bullets" },
>				      { "title": "Key Points Discussed", "format": "bullets" },
>				      { "title": "Follow Up Action Items", "format": "bullets" },
...
6. Enabling from the dashboard takes the following default values.