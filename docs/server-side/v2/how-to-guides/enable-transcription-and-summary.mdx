...
<StepsToc
    ...
    descriptions={[
        ...
        'Enabling transcription and summary through various methods.',
...
### Enabling Speaker Labelled Transcription and AI-Generated Summary
...
```json
{
	"summary": { // only if summary was enabled
						"sections": [
								{
									"title": "Speakers", 
									"format": "bullets", 
