...
This is a guide to enable 100ms **post call transcription** with **speaker labels** and **AI-generated summary**. The feature is currently in `Beta`. In case you’ve missed our launch note, you can read it [here](https://www.100ms.live/blog/transcript-summary-launch).
...
The above flowchart shows the entire workflow of transcription and summary generation and their consumption. 
...
<video loop="true" autoplay="autoplay" controls="controls" id="vid" muted>
	 <source src="public/docs/v2/transcription-dashboard-config.mp4" type="video/mp4" />
</video>
<br />
...
> The following are the default values with which the dashboard implementation initiates transcription and summary. If you want to understand more about these and use custom values, you can refer to our [Policy API](https://www.100ms.live/docs/server-side/v2/api-reference/policy/create-template-via-api).
> ``` json
>{
>  "transcription": {
...
<video loop="true" autoplay="autoplay" controls="controls" id="vid" muted>
    <source src="public/docs/v2/transcription-dashboard-consumption.mp4" type="video/mp4" />
</video>
<br />
...
5. This feature only supports **English** language as of now.