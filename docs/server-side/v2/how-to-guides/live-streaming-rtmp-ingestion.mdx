...
The first step is to create a template which is suitable for RTMP media ingestion followed by live streaming through HLS.
...
- Reset or disable the stream key for the given room.
