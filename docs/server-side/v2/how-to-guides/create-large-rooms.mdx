...
If the room is very large, it is difficult to fetch each and every peer. To get a **list of peers** or the **peer count** of the room, use the following documentation:
