...
This endpoint is used to modify a Template. Providing the same name as a previous template overrides that template. You need to provide all options for roles and settings to which you want to apply.
