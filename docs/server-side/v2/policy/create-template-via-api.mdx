...
| width           | `int`    | Indicates the width of the screen to be recorded in pixels. For example, 1280 pixels. <br/><br/> **Min, default, & max** = 500, 1280, 1920.                                                       | No       |
| height          | `int`    | Indicates the height of the screen to be recorded in pixels. For example, 720 pixels. <br/><br/> **Min, default, & max** = 480, 720, 1920.                                                        | No       |
| maxDuration     | `int`    | Sets the maximum duration, in seconds, of the recording. For example, 1800 seconds (30 mins). <br/><br/> **Min, default, & max** = 1800 (30 mins), 14,400 (4 hours), 28,800 (8 hours)             | No       |
| thumbnails      | `object` | Object of type `thumbnails`. This can be used to configure thumbnail's dimension                                                                                                                  | No       |
| presignDuration | `int`    | Indicates the expiry of the pre-signed URLs—the duration for which the pre-signed URL should be signed. <br/><br/> **Min, default, & max** = 3,600 (1 hour), 2,59,200 (3 days), 6,04,800 (7 days) | No       |
...
| numPlaylistSegments     | `int`     | Indicates the number of media segments in the playlist. Applicable only for `live` playlistType. <br/><br/> **Min, default, & max** = 3, 5, 12.                                       | No       |
| videoFrameRate          | `int`     | Set this argument to configure the frames per second (or FPS) for your stream. For example, 25. <br/><br/> **Min, default, & max** = 10, 20, 30.                                      | No       |
...
| singleFilePerLayer | `boolean` | Set this to true if the desired result is an mp4 file per HLS layer. Defaults to false.                          | No       |
...
| Name         | Type  | Description                                                                                                                              | Required |
| :----------- | :---- | :--------------------------------------------------------------------------------------------------------------------------------------- | :------- |
| width        | `int` | Indicates the width of the screen to be recorded in pixels. For example, 1280 pixels. <br/><br/> **Min, default, & max** = 240, -, 1920. | No       |
| height       | `int` | Indicates the height of the screen to be recorded in pixels. For example, 720 pixels. <br/><br/> **Min, default, & max** = 240, -, 1920. | No       |
| videoBitrate | `int` | Bitrate of video track in kbps. For example, 200 kbps. <br/><br/> **Min, default, & max** = 200, -, 5500.                                | No       |
| audioBitrate | `int` | Bitrate of audio track in kbps. For example, 32 kbps. <br/><br/> **Min, default, & max** = 32, 64, 128.                                  | No       |
