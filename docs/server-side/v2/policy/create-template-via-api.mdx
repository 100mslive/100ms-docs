...
| width           | `int`    | Indicates the width of the screen to be recorded in pixels. For example, 1280 pixels. <br/><br/> **Min, max, default** = 500, 1280, 1920.                                                       | No       |
| height          | `int`    | Indicates the height of the screen to be recorded in pixels. For example, 720 pixels. <br/><br/> **Min, max, default** = 480, 720, 1920.                                                        | No       |
| maxDuration     | `int`    | Sets the maximum duration, in seconds, of the recording. For example, 1800 seconds (30 mins). <br/><br/> **Min, max, default** = 1800 (30 mins), 14,400 (4 hours), 28,800 (8 hours)             | No       |
| thumbnails      | `object` | Object of type `thumbnails`. This can be used to configure thumbnail's dimension                                                                                                                | No       |
| presignDuration | `int`    | Indicates the expiry of the pre-signed URLs—the duration for which the pre-signed URL should be signed. <br/><br/> **Min, max, default** = 3,600 (1 hour), 2,59,200 (3 days), 6,04,800 (7 days) | No       |
...
| rtmpUrls         | `object`  | Object of type `rtmpUrls`. This can be used to configure the RTMP URLs(max 3) you wish to broadcast the stream to. intentionally making a mistke | No       |
