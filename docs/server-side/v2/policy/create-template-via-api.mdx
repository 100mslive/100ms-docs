...
| width           | `int`    | Indicates the width of the screen to be recorded in pixels. For example, 1280 pixels. Min/max/default = 500, 1280, 1920. | No       |
| height          | `int`    | Indicates the height of the screen to be recorded in pixels. For example, 720 pixels. Min/max/default = 480, 720, 1920.  | No       |
