...
| Name       | Type                                                                                                  | Description                                                               |
| :--------- | :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------ |
| `settings` | `Partial`<[`HMSAudioTrackSettings`](/api-references/javascript/v2/interfaces/HMSAudioTrackSettings)\> | HMSAudioTrackSettings ({ volume, codec, maxBitrate, deviceId, advanced }) |
...
| Name       | Type                                                                                                  | Description                                                                                    |
| :--------- | :---------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------- |
| `settings` | `Partial`<[`HMSVideoTrackSettings`](/api-references/javascript/v2/interfaces/HMSVideoTrackSettings)\> | HMSVideoTrackSettings ({ width, height, codec, maxFramerate, maxBitrate, deviceId, advanced }) |
