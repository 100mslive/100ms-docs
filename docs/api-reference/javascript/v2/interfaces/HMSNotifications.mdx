...
| Name    | Type                                                                                                                                                                     |
| :------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cb`    | [`HMSNotificationCallback`](/api-reference/javascript/v2/home/content#hmsnotificationcallback)                                                                           |
| `type?` | [`HMSNotificationTypes`](/api-reference/javascript/v2/enums/HMSNotificationTypes) \| [`HMSNotificationTypes`](/api-reference/javascript/v2/enums/HMSNotificationTypes)[] |
