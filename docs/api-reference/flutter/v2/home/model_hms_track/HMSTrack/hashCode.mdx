...
that affects <a href="../../model_hms_track/HMSTrack/operator_equals">operator ==</a> comparisons.</p>
...
the same way as the default <a href="../../model_hms_track/HMSTrack/operator_equals">operator ==</a> implementation only considers objects
...
<p>If <a href="../../model_hms_track/HMSTrack/operator_equals">operator ==</a> is overridden to use the object state instead,
...
according to <a href="../../model_hms_track/HMSTrack/operator_equals">operator ==</a>.
...
<p>If a subclass overrides <a href="../../model_hms_track/HMSTrack/hashCode">hashCode</a>, it should override the
<a href="../../model_hms_track/HMSTrack/operator_equals">operator ==</a> operator as well to maintain consistency.</p>
