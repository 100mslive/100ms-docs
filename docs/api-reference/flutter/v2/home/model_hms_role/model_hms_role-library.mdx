...
<p>Each HMSPeer instance has a role property which returns an <a href="../model_hms_role/HMSRole-class">HMSRole</a> instance. You can use this property to do following:</p>
...
<p><a href="../model_hms_role/HMSRole-class">HMSRole</a> contains details about the role.</p>
