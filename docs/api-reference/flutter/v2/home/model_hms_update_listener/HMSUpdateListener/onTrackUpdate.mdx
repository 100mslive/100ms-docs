...
void onTrackUpdate
({required [HMSTrack](../../model_hms_track/HMSTrack-class) track, required [HMSTrackUpdate](../../enum_hms_track_update/HMSTrackUpdate-class) trackUpdate, required [HMSPeer](../../model_hms_peer/HMSPeer-class) peer})
