...
void onTrackUpdate
({required [HMSTrack](../../hmssdk_flutter/HMSTrack-class) track, required [HMSTrackUpdate](../../hmssdk_flutter/HMSTrackUpdate-class) trackUpdate, required [HMSPeer](../../hmssdk_flutter/HMSPeer-class) peer})
