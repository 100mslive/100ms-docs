...
({required [HMSConfig](../../model_hms_config/HMSConfig-class) config})

<p>preview before joining the room pass <a href="../../model_hms_config/HMSConfig-class">HMSConfig</a>.</p>
