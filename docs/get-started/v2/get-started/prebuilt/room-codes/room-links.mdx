...
A Room Link is a link that a role peer can use to join a room. It is always associated to a specific room and role, allowing unique room links for each role in a room.
