...
100ms Prebuilt is a feature rich video conferencing / live streaming app built on top on our [sample web app]. Share Prebuilt room links with users or [embed it as an iFrame](/get-started/v2/get-started/prebuilt/prebuiltNew#embedding-as-iframe) in your application.
...
![Links](/docs/v2/joinprebuilt.png)


- Customise Prebuilt that fits your use case **[coming soon]**
