...
1. Roles
    ...
    - customer
        1. Publish Strategy -
            - Role can share: Audio, Video; No Screenshare
            - Video Quality: 720p
              Note: Even though 720p has been set, our SDK will automatically degrade if the upload bandwidth is not enough, but it will never turn off the video.
