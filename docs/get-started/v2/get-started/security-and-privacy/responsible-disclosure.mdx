...
- In case you uncover or run into personal identifiable information (PII) of any user(s), please refrain from sharing, storing or using the information in any way or form once the vulnerability and breach has been reported.
...
- Recommendations for fixes, mitigations, or temporary workarounds to address the reported issue
