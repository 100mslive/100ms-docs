...
<Callout icon="LinkTwoIcon" title="Pre-built">
Generate room links or embed the 100ms web app as an iframe in your app

[Integrate pre-built](/get-started/v2/get-started/prebuilt/overview)

</Callout>

<Callout icon="ShieldIcon" title="Custom UI">
...
-   [Recordings](/get-started/v2/get-started/features/recordings/overview)
