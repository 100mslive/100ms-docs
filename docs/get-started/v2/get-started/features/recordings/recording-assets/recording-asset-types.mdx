...
A recording can be anything, a text, a individual peers audio, another's video. everything that can be recorded is stored as an asset type that can be retrived and managed using Recording Assets APIs and recording asset webhooks.
