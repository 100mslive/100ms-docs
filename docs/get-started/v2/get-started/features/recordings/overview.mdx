...
<Callout title="Storage configuration" icon="ShieldIcon">
    Understand how to store your recordings. Refer [storage configuration
    →](/get-started/v2/get-started/features/recordings/recording-assets/storage-configuration)
</Callout>
