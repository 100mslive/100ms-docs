...
<FlexContainer>
<Callout title="Choosing a recording mode" icon="RecordIcon">
Compare track, stream and composite recordings for your use cases. <br/> [Compare recording modes →](/get-started/v2/get-started/features/recordings/recording-modes/comparing-recording-modes)
</Callout>
</FlexContainer>
...
<Callout title="Recording asset types" icon="FilesIcon">
Different assets types generated on 100ms. <br/> [View recording assets →](/get-started/v2/get-started/features/recordings/recording-assets/recording-asset-types)
</Callout>

<Callout title="Storage configuration" icon="BoxIcon">
Understand how to store your recordings. <br/> [Refer storage configuration →]((/get-started/v2/get-started/features/recordings/recording-assets/storage-configuration))
</Callout>

<Callout title="Get recording assets" icon="LinkIcon">
Fetch recording asset types generated. <br/> [Get recording assets →](/get-started/v2/get-started/features/recordings/recording-assets/get-recoding-assets)
</Callout>
...
<Callout title="Recording API" icon="LinkIcon">
...
- [Track Recording events →](/docs/server-side/v2/how-to-guides/configure-webhooks/webhook#track-recording-events)
- [Stream webhooks →](/docs/server-side/v2/how-to-guides/configure-webhooks/webhook#stream-recording-events)
- [Composite webhooks →](/docs/server-side/v2/how-to-guides/configure-webhooks/webhook#rtmp-streaming-browser-recording-events)
</Callout>
</FlexContainer>