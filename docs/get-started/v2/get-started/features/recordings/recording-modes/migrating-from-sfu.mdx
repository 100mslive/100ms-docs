...
If you're using Custom Composite(SFU) recordings,  you can easily migrate to browser based recordings from 100ms dashboard. Follow these steps to migrate:

1. Visit your template on [100ms dashboard](https://dashboard.100ms.live/dashboard).
2. Go to Recordings tab and switch to browser recordings.

![migration](/docs/v2/browser.png)
