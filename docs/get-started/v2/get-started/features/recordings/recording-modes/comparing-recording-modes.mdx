...
| Components | Single recording type e.g. one video track | Typically one video and audio stream | Capture UI via a browser| Multiple tracks across all participants |
