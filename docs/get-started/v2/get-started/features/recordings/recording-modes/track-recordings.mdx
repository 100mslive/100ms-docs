...
1. Get track `asset_id`
	...
	- **Using track.recording.success-** triggered when a track recording is completed for a peer
...
4. Call the Get Recording Asset API using the track's `asset_id` to download the actual recording.
