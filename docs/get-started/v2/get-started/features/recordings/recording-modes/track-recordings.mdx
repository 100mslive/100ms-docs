...
1. Using **[List Recording Assets API]**(/server-side/v2/aoi-reference/recording-assets/list-all-assets) get the all tracks recording assets for a session_id and asset_type=`track`
