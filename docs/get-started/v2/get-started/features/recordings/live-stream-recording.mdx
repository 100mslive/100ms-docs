...
> - If you're using 100ms storage, you cannot choose the option of zipped M3U8 upload on any newly created templates which are created after the above given date.
