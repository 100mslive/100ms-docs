...
1. Configure your recording storage. Use [this guide](/get-started/v2/get-started/features/recordings/storage) as your reference. Depending upon your choice of storage (100ms hosted or personal cloud storage), you will be met with slightly different options when configuring recording during live streams.
2. Enable and configure your [live stream on the dashboard](/get-started/v2/get-started/features/live-streaming#customize-the-stream). 
...
|                                  | 100ms Hosted                                                                                        | Personal Cloud (Non-100ms)                                                     |
|:---------------------------------|:----------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------|
