...
<Note>
By default, Noise Cancellation is disbaled for all the peers in the session. To enable Noise Cancellation by default for all the peers check below section.
</Note>
