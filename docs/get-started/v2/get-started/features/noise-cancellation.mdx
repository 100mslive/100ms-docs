...
### Enabling the Noise cancellation
...
1. **Is Noise cancellation a chargeable feature?**
    ...
    Yes, 100ms Noise cancellation is charged based on per peer usage minutes. This means that for every peer that is enabling noise cancellation during session, their individual usage minutes will be aggregated. For more check [100ms pricing page](https://www.100ms.live/pricing/) or reach out to us.
