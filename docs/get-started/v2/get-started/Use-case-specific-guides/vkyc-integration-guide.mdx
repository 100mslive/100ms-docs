...
4. Add [cloud storage bucket details on the 100ms Dashboard](/get-started/v2/get-started/features/recordings/storage) in the Recordings tab of your template to store your recordings.
