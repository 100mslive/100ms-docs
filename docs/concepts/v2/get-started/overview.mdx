...
Learn about other [100ms primitives](./core-concepts/basics).
...
* [Basic architecture](./core-concepts/basics.mdx)
* [Primitives](./core-concepts/basics.mdx)
* [Authentication](./authentication/security-and-tokens.mdx)
...
[Integrate pre-built](./prebuilt-or-custom-UI/prebuilt)
</Callout>
...
* [Recordings](./discover-features/recordings)
* [Live streaming](./discover-features/live-streaming)
