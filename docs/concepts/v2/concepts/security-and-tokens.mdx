...
In 100ms, two types of JWT tokens are used to authenticate requests coming from your client apps and backend server.
...
-   [Get from the dashboard](#get-auth-tokens-from-the-dashboard): Get 
-   [Get from the token endpoint](#get-auth-tokens-from-the-token-endpoint)
-   [Set up your token server](#set-up-your-token-server)
