...
100ms _client-side SDKs_ use Auth Tokens to authenticate while [joining a room](/javascript/v2/features/join). Generate this token on the server side and make it available for your client-side apps that use the 100ms SDKs.
