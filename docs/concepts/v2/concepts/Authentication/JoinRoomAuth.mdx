...
- We have now introduced a new, simpler way for you to set up Authentication to join Rooms using [Room Codes](https://www.100ms.live/docs/concepts/v2/concepts/rooms/room-codes/room-codes) as a secondary way to Join Rooms. You don't need to set up a Token service to generate Auth Token when using Room Codes.
...
| :----------- | :---------- |
| [Auth Token](/concepts/v2/concepts/Authentication/AuthToken) | 1. [No-Code Setup](/concepts/v2/concepts/Authentication/AuthToken#no-code-auth-token-setup) 2. [Programmatically Generate Auth Token](/concepts/v2/concepts/Authentication/AuthToken#set-up-auth-token-Programmatically) |
| [Room Code Authentication](/concepts/v2/concepts/Authentication/RoomCodesAuth) | 1. [No-Code Setup](/concepts/v2/concepts/Authentication/RoomCodesAuth#no-code-setup) 2. [Programmatically Generate Room Codes](/concepts/v2/concepts/Authentication/RoomCodesAuth#Programmatically-generate-room-codes) |
...
![Join Room Authentication](/docs/v2/JoinRoomAuthv2.png)
