...
- Update the collection variables APP_ACCESS_KEY and APP_SECRET in the 100ms API Collection. You can access the **App Access Key** and **App Secret** from 100ms **[dashboard](https://dashboard.100ms.live/developer)** under [Developer Section](https://dashboard.100ms.live/developer)
...
### Generate Management Token Programatically
