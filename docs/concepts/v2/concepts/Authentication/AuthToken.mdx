...
- Get temporary auth tokens from 100ms **[dashboard](https://www.100ms.live/docs/javascript/v2/guides/token#get-a-temporary-token-from-100ms-dashboard)**
...
### Set up Auth Token Programmatically
...
You can Programmatically generate Auth Tokens using:
