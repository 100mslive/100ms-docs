...
Make sure to use only enabled Room Codes to create Room Links. Read about [Room Code Basics](/concepts/v2/concepts/Rooms/room-codes#room-code-basics)
