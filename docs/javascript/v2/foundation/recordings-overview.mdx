...
This section shows how to configure a cloud destination (e.g AWS S3) for all your recordings.
...
&nbsp;
  ...
  ![Screenshot 2022-09-28 at 1.21.23 PM.png](https://100msscreenshotbucket.s3.ap-south-1.amazonaws.com/Screenshot%2B2022-09-28%2Bat%2B1.24.09%2BPM.png)
&nbsp;
&nbsp;
