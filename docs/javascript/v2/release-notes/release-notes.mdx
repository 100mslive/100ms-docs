...
- In Roomkit Prebuilt, now on Mobile Browsers, Stats for Nerds is available to be viewed. Also, new sections with init config added.
...
- Roomkit Prebuilt: Peer stuck on loading screen after staying in preview for 15 mins instead of being redirected to the rejoin page
