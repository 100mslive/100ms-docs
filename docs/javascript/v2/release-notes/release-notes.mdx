...
Released: `@100mslive/hms-video-store@0.2.90`, `@100mslive/react-sdk@0.0.7`, `@100mslive/hms-video-react@0.3.117`
...
-   input/output interfaces of `useVideo` has been changed. check [react quickstart](../gudies/react-quickstart) for reference.
