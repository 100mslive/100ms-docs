...
-   Fix server-side subscribe degradation
-   Fix handling auxiliary regular tracks
-   Fix token errors - made terminal 

## 2022-05-09

Released: `@100mslive/hms-video-store@0.2.99`, `@100mslive/react-sdk@0.0.16`, `@100mslive/hms-video-react@0.3.127`
