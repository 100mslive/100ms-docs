...
<br/> We highly recommend you to update any business logic dependent on beam's *peer webhook events* and instead use *[beam webhook events](/server-side/v2/how-to-guides/configure-webhooks/webhook#rtmp-streaming-browser-recording-events)*.
