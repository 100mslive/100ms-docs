...
-   A [new method](/docs/api-reference/javascript/v2/interfaces/HMSActions#autoselectaudiooutput) is exposed to give more control to the user to select audio output on mobile web. This is already done internally, so most of the times this will not be required to be explicitly used from the application.
