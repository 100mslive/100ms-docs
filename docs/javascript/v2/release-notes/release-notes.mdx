...
### Fixed:
- Roomkit Prebuilt: HLS player takes more space in fullscreen mode
- Roomkit Prebuilt: Device label categorization
- Avatar showing when returning from background in mweb
- Linear retry timeout for reconnection
- Roomkit Prebuilt: Feedback submission endpoint
- Video not recovering after degradation gets fixed
