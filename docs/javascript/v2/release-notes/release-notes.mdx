...
### Added:
- Start and stop events for transcriptions
...
- Roomkit Prebuilt: Mweb UI fixes for leaderboard and blocked, disabled chat states
- Roomkit Prebuilt: Virtual background disappears after returning from background on mweb
