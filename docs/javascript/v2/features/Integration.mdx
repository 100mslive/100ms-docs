...
you'll have a delightful experience walking through and integrating our sdk.
...
from the [dashboard account](https://dashboard.100ms.live). The code for this sample is open sourced [here](https://github.com/100mslive/100ms-web-v2).
