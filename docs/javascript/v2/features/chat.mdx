...
if you're looking for implementing something like raise hand do checkout our documentation for [peer metadata](../features/peer-metadata).

> In case you want to send large information in a structured way than a simple string will allow, you can always send a stringified JSON object.
