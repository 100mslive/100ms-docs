...
2. [`Bulk Peer Role API`](#change-bulk-peer-role-api) - We could change a role of all the peer to another role. It will be helpful to make breakout rooms, waiting rooms, etc.
