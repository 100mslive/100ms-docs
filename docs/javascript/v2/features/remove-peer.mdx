...
In the SDK, the permission to remove others from the room `removeOthers` and you should check for that within the [HMSRole.permissions](../../../api-reference/javascript/v2/interfaces/HMSRole#permissions) of the peer to see if they have it.
