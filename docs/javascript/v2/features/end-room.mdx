...
Use the [selectPermissions](../../../api-reference/javascript/v2/home/content#select-permissions) selector to check whether the local peer has the `endRoom` permission to end the room.

Once you're sure the peer has the permissions to end the room they can call for the room to end when they're ready with [`hmsActions.endRoom`](../../../api-reference/javascript/v2/interfaces/HMSActions#end-room).
