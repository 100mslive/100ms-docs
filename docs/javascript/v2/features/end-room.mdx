...
All the participants in the room must be using applications that have the following SDK versions at minmum for end room API to be compatible.

-   Web SDK
    -   `@100mslive/hms-video@0.1.32`
    -   `@100mslive/hms-video-store@0.2.79`
    -   `@100mslive/hms-video-react@0.3.105`
-   Android
    -   `2.1.9`
-   iOS
    -   `0.2.1`
