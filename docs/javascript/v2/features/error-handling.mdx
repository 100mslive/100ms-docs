...
| **3005**       | There is no media to return. Please select either video or audio or both.                                 | TODO                                                                                                        |
...
| **3010**       | No audio detected from track, indicates problem with device hardware                                      | TODO                                                                                                        |
...
| **5000**       | Server error for Join                                                                                     | TODO                                                                                                        |
...
| **6001**       | Unknown signalling error: {action} {error_info}                                                           | TODO                                                                                                        |
| **6002**       | WebRTC Error: Error while renegotiating                                                                   | TODO                                                                                                        |
| **6003**       | WebRTC engine is not ready yet                                                                            | TODO                                                                                                        |
| **6004**       | Failed to parse JSON message                                                                              | Need to debug further with logs.                                                                            |
| **6005**       | Track Metadata Missing                                                                                    | TODO                                                                                                        |
| **6006**       | RTC Track missing                                                                                         | TODO                                                                                                        |
| **6007**       | Peer Metadata Missing                                                                                     | TODO                                                                                                        |
...
| **8002**       | Playlist: Invalid action call                                                                             | TODO                                                                                                        |
