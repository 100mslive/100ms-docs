...
The notification `type` is a string and can only take values from the list below.
...
class HMSNotificationTypes {
    static PEER_JOINED: string; // notification.data will be HMSPeer
    static PEER_LEFT: string; // notification.data will be HMSPeer
    static NEW_MESSAGE: string; // notification.data will be HMSMessage
    static ERROR: string; // notification.data will be HMSException
