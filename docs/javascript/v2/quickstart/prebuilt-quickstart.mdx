...
-   _Room-code_: Prebuilt component requires a room-code to join a room. You can get a room-code for a room using the 100ms dashboard. Refer [this](https://www.notion.so/get-started/v2/get-started/prebuilt/room-codes/overview) guide to learn more about room-codes.
...
![Preview](/docs/v2/prebuilt-room.png)