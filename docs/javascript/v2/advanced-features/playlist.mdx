...
-   You can play/pause the audio/video playlist
-   You can play next/previous audio/video playlist
-   You can control the volume of the audio/video playlist
...
The following actions can be performed on the playlist:
...
## Accessing Audio/Video Playlist tracks
