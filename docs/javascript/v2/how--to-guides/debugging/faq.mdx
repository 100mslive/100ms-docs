...
#### Can I have multiple instances of HMSRoomProvider each mapping to a different room?

Starting from this [release](https://www.100ms.live/docs/javascript/v2/changelog/release-notes), you should be able to do it. Here is an example:
...
Room1, Room2 can have the details of the room to which they want to point to
