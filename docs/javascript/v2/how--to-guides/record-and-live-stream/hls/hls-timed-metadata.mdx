...
- It’s hard to sync metadata with stream exactly due to the latency from FFmpeg creating the stream. To address this, we’ve added 2 s delay of the actual `START-DATE` attribute.
