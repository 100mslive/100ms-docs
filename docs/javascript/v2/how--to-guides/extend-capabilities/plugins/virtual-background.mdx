...
- Use background images that match the video publish aspect ratio set from dashboard template.
  Eg: For 4:3 aspect ratio, image should be a minimum of 640x480 or higher.
- Image may look stretched depending on video element size, so it should be closer to the video element size
