---
title: Collaborative Whiteboard setup
nav: 7.5
---
...
You need three components to complete the Collaborative whiteboard demo:

1. [Pusher Channels app](#usher-channels-app)
2. [Whiteboard server](#whiteboard-server) — this guide follow vercel deployment.
3. [Whiteboard client](#whiteboard-client) - this guide uses [100ms-web sample app](https://github.com/100mslive/100ms-web).

## Pusher Channels App

-   Sign up for [Pusher account](https://pusher.com/).
