...
Check [this section](#sspecifying-custom-frame-rate-optional) to use custom pluginFrameRate
...
`pluginFrameRate`- Int - It can be used to set the processing frame rate of virtual background plugin.<br/>
