...
`pluginFrameRate`- number - It can be used to set the processing frame rate of virtual background plugin.
 ...
 The user can specify this based on device type and CPU usage. If you're seeing CPU spikes and continuous heat up on turning
 on virtual background, you may reduce the pluginFrameRate further.<br/>
