...
-  `gifURL` - String - This is the URL of the gif with which the background will be replaces
...
Image/Video passed will get fit to the camera video by maintaining the aspect ratio.
