...
You can join the above room using room code from [dashboard](https://dashboard.100ms.live/dashboard). Refer [this](https://www.100ms.live/docs/concepts/v2/concepts/rooms/room-codes/room-codes) for more details about room code.
