...
<iframe 
  src="https://www.loom.com/embed/6547b535fc1049a9b3b5f97588884c98"
  frameborder="0" 
...
<iframe
  src="https://www.loom.com/embed/0f1c5e0ed84343629058c4d9d5e4ac57" 
  frameborder="0" 
  webkitallowfullscreen 
  mozallowfullscreen 
  allowfullscreen 
...
-   `roomCode`: A Room Code is a unique encrypted short code generated by 100ms for a given `role` and `room`. A `room code` represents a unique `role` and `room_id` combination. You can read about how to generate this token [here](/concepts/v2/concepts/rooms/room-codes/room-codes).
