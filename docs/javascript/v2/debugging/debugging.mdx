...
Detailed steps to reproduce the issue. You can also give us a <a onClick={()=>{window.analytics.track("codesandbox.viewed",{path:window.location.pathname});window.open("https://codesandbox.io","_blank")}}>codesandbox</a> where the issue can be seen, feel free
