...
```js section=ConnectedRoom sectionIndex=1 tab=JS
...
```jsx section=Dependencies sectionIndex=1 tab=React
...
```js section=Preview sectionIndex=1 tab=JS
...
```jsx section=Preview sectionIndex=1 tab=React
...
```js section=PeerCount sectionIndex=1 tab=JS
...
```jsx section=PeerCount sectionIndex=1 tab=React
...
```js section=inRoom sectionIndex=1 tab=JS
...
```jsx section=inRoom sectionIndex=1 tab=React
...
```js section=RoomState sectionIndex=1 tab=JS
...
```jsx section=RoomState sectionIndex=1 tab=React
...
```js section=MicVideoToggle sectionIndex=1 tab=JS
...
```jsx section=MicVideoToggle sectionIndex=1 tab=React
...
```js section=MicVideoStatus sectionIndex=1 tab=JS
...
```js section=VideoStream sectionIndex=1 tab=JS
...
```jsx section=VideoStream sectionIndex=1 tab=React
