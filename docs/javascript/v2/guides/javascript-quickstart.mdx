...
In this walkthrough, we will use [ParcelJS](https://parceljs.org/getting-started/webapp/) a web application bundler that requires zero configuration. If you wish to use any other library or framework, you can set up your app using that.
