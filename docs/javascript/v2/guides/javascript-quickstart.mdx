...
In this walkthrough, we’ll use ParcelJS a web application bundler that requires zero configuration. If you wish to use any other library or framework, you can set up your app using that. 

### Initialize a project
You can initialize a project using `npm init` or `yarn init`.
