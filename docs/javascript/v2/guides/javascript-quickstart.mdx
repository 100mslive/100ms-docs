...
```html:index.html section=completeCodeExample sectionIndex=2 tab=HTML
<!DOCTYPE html>
<html>
  <head>
...
```css:styles.css section=completeCodeExample sectionIndex=3 tab=CSS
* {
    margin: 0;
    padding: 0;
...
```html:index.html section=InitializingTheSDK sectionIndex=3 tab=HTML
<!DOCTYPE html>
<html>
  <head>
    <title>Quickstart JS</title>
...
```css:styles.css section=InitializingTheSDK sectionIndex=4 tab=CSS
* {
    margin: 0;
    padding: 0;
    box-sizing: border-box;
...
```html:index.html section=JoiningRoom sectionIndex=2 tab=HTML
<!DOCTYPE html>
<html>
  <head>
    <title>Quickstart JS</title>
...
```css:styles.css section=JoiningRoom sectionIndex=3 tab=CSS
* {
    margin: 0;
    padding: 0;
    box-sizing: border-box;
...
```html:index.html section=SubscribingToTheState sectionIndex=2 tab=HTML
<div id="conference" class="conference-section hide">
    <h2>Conference</h2>
    <div id="peers-container"></div>
</div>
...
```css:styles.css section=SubscribingToTheState sectionIndex=3 tab=CSS
  form h2,
  .conference-section h2 {
    margin-bottom: 20px;
  }
...
```html:index.html section=MutingUnmutingLocalTracks sectionIndex=2 tab=HTML
...
```css:styles.css section=MutingUnmutingLocalTracks sectionIndex=3 tab=CSS
  .control-bar {
    display: flex;
    position: fixed;
    bottom: 0;
