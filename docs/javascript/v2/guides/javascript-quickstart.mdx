...
Then, install ParcelJS and 100ms SDK into your app:

-   using Yarn `yarn add --dev parcel @100mslive/hms-video-store` or
-   when using npm run `npm install --save-dev parcel-bundler @100mslive/hms-video-store`.
