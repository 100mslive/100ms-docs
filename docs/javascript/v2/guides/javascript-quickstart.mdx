...
npm install --save-dev parcel-bundler @100mslive/hms-video-store
```
...
2. Use the `Live Streaming Starter Kit` to create a room with a default template assigned to it to test this app quickly.
