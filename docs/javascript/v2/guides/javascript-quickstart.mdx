...
> **Note:** Please ensure to add the Javascript and CSS dependencies to your HTML file. <br/><br/>
> `<link rel="stylesheet" href="src/styles.css" />` <br/>
> `<script type="module" src="src/index.js"></script>`
...
![Mute/Unmute](/guides/two-peers.gif)
