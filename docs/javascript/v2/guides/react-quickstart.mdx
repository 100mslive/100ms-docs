...
```jsx:src/index.js section=SDK sectionIndex=1
...
```jsx:src/JoinForm.jsx section=Join sectionIndex=1
...
```jsx{2-8}:src/App.jsx section=Leave sectionIndex=1
export default function App() {
  const hmsActions = useHMSActions();
...
```jsx:src/Conference.jsx section=Fetch sectionIndex=2
...
```jsx:src/Peer.jsx section=Fetch sectionIndex=3
...
```jsx{5,8,13,17,22-26}:src/App.jsx section=ChangeUI sectionIndex=1
import "./styles.css";
...
```jsx:src/Footer.jsx section=MuteLocalTrack sectionIndex=1
...
```jsx{1,19-22}:src/App.js section=MuteLocalTrack sectionIndex=2
