...
```jsx src/App.jsx section=LeavingTheRoom sectionIndex=1
export default function App() {
  const hmsActions = useHMSActions();
...
```jsx src/App.jsx section=ChangingUIBasedOnConnectionState sectionIndex=1
import "./styles.css";
...
```jsx src/App.js section=MutingUnmutingLocalTracks sectionIndex=2
