...
```jsx:src/App.jsx section=JoiningRoom sectionIndex=2
...
```jsx{2-8}:src/App.jsx section=LeavingTheRoom sectionIndex=1
export default function App() {
  const hmsActions = useHMSActions();
...
```jsx{5,8,13,17,22-26}:src/App.jsx section=ChangingUIBasedOnConnectionState sectionIndex=1
import "./styles.css";
...
```jsx{1,19-22}:src/App.js section=MutingUnmutingLocalTracks sectionIndex=2
