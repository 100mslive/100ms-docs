...
- Remove black border in the live video stream
- Audio volume goes down to zero on device change
- Role change with simulcast
- Audio level border broken on beam recording
- Audio of some peer not audible
