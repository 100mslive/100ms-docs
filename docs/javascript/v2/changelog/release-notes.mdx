...
- Meeting URL made optional for [RTMP Streaming / Recording APIs](/docs/javascript/v2/how-to-guides/record-and-live-stream/rtmp-recording)
- [HLS Player](/docs/javascript/v2/how-to-guides/record-and-live-stream/hls/hls-player) switching to higher quality layer made more aggressive to ensure high quality live stream.
