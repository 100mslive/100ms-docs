...
#### Added:
- Simulcast support
- New virtual background plugin with improved cpu usage compared to the previous one (alpha). Refer [usage](https://github.com/100mslive/100ms-web/blob/main/src/plugins/VirtualBackground/VirtualBackground.jsx)
