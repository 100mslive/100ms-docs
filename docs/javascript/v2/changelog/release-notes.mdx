...
We released Prebuilt. Customize your app themes and add video conferencing to your app with one line of code.
Details [here](https://www.100ms.live/docs/javascript/v2/quickstart/prebuilt-quickstart)

### Fixed: 
- Showing the correct video aspect ratio for mobile web.
- Screenshare track was showing presenter video track.
