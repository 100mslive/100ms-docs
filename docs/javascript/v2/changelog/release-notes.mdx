...
#### Added:
- [`speakerAutoSelectionBlacklist`](https://www.100ms.live/docs/api-reference/javascript/v2/interfaces/HMSConfigInitialSettings#speaker-auto-selection-blacklist) in `HMSConfigInitialSettings` to ignore audio input-output device matching to 
