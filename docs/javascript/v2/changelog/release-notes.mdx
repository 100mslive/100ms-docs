...
#### Added:
- Simulcast support
- Added new virtual background with improved cpu usage compared to the previous one (alpha). Refer [usage](https://github.com/100mslive/100ms-web/blob/main/src/plugins/VirtualBackground/VirtualBackground.jsx)
