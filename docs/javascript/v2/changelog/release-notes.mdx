...
### Added:
- [New API](/javascript/v2/how-to-guides/set-up-video-conferencing/peerlist-optimizations) for handling peer list optimizations
- Reduced time taken for updating the hls live status
- Warning to move to Portrait for Prebuilt when in landscape(Landscape will be fixed in the future)
