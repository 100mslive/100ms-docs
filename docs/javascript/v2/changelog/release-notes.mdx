...
- `hasNext` is now part of in `usePaginatedParticipants` response

### Fixed:
- Roomkit Prebuilt: Internal React Router is now removed. This will allow it easy to use in next.js and remix
