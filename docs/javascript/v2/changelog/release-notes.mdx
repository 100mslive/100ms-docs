...
Released: `@100mslive/hms-video-store@0.7.0`, `@100mslive/react-sdk@0.5.0`

#### Fixed:
- react-sdk failing in nextjs environment
- fix dropdown from react-ui making the ui unresponsive when closed
...
#### Breaking
- customerDescription on peer is now removed. use `metadata` field instead.
