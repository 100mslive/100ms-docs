...
### Fixed: 
- Capture video at correct aspect ratio for mobile web - `@100mslive/hms-video-store`
- Screenshare track was showing presenter video track on role change  - `@100mslive/hms-video-store`
