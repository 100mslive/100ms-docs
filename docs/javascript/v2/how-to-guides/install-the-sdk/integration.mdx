...
<PageCard showCta={false} showImage={false} showTag={false} title={"Basic Concepts"} icon={"PipIcon"} description={"Learn the basic architecture to understand how your app talks to 100ms servers"} />
...
Do checkout our debugging page [here](/javascript/v2/how--to-guides/debugging/overview) for an easy debugging experience while integrating our SDK.
