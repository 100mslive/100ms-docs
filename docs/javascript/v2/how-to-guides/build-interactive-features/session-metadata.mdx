...
This version of session metadata is deprecated. Please refer [Session Store](/javascript/v2/how--to-guides/build-interactive-features/session-store) for documentation of the latest version.
