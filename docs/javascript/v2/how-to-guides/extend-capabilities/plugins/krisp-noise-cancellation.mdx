...
<Note type='warning'>
**IMPORTANT** <br/>
Enable Noise cancellation in the template configurationn. Learn more on enabling this feature from [here](/get-started/v2/get-started/features/noise-cancellation#enabling-the-noise-cancellation)
</Note>
