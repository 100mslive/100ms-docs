...
<Note>
    It is recommended to integrate the Effects Virtual Background for better cross browser compatibility and customisability. The integration document can be referred to [here](./effects-virtual-background).
</Note>
