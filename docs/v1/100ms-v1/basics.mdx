...
4. Client publishes its audio/video stream and/or subscribes to remote streams
...
If you just want to see 100ms' SDKs in action in under 5 minutes, run one of our quickstart apps - [Web](https://github.com/100mslive/100ms-web), [Android](https://github.com/100mslive/100ms-android), [iOS](https://github.com/100mslive/100ms-ios)
