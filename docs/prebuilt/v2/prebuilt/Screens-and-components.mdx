...
##### Noise Cancellation State
	- Turn the toggle to define the initial state for noise cancellation on Prebuilt.
	  ...
	  <Note> 
	  Noise cancellation should be enabled from 'Advanced Settings' under the Template to enable this setting.
	  </Note>
