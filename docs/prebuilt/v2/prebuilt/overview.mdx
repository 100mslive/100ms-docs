...
-   Get React Native [Android App here](https://appdistribution.firebase.dev/i/7b7ab3b30e627c35) and the [iOS App here](https://testflight.apple.com/join/v4bSIPad)
...
<SuggestedBlogs
    suggestedBlogs={[
        {
            title: 'Video Calling Application in Flutter using 100ms Prebuilt',
            content:
            ...
            date: 'January 2, 2024 • 8 min read',
            url: 'https://www.100ms.live/blog/prebuilt-flutter-component'
        },
        {
            ...
            date: 'September 29, 20231 • 3 min read',
            url: 'https://www.100ms.live/blog/ios-roomkit'
        },
        {
            ...
            date: 'September 13, 2023 • 4 min read',
            url: 'https://www.100ms.live/blog/embed-prebuilt-native-components'
        }
    ]}
/>
