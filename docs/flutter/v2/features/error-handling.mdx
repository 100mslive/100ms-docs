...
`isTerminal` property of HMSException object can be used to check whether the error is a terminal error.
...
While in other case the error can be handled accordingly.
