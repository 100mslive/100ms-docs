...
### Step 1 - Edit Podfile
1. Expand ios folder and open `Podfile`.
...
```dart
HMSSDK(appGroup: "group.domain.name", preferredExtension: "extension.domain.name")
```
