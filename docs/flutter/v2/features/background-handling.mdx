...
### Android Behaviours when app goes to background without enabling blackground processing

| **Scenario**   | **Behaviours**                                 |
| :------------- | :----------------------------------------------------- |
| Mic is unmuted | It will remain unmuted and the user will able to publish audio for limited period (time depend on OS) |
| Camera is unmuted | It will remain unmuted and the user will able to publish video for limited period (time depend on OS)  |
| Remote Peer is publishing audio | Able to play incoming audio from the room |

### Android Behaviours when app goes to background with enabling blackground processing

| **Scenario**   | **Behaviours**                                 |
| :------------- | :----------------------------------------------------- |
| Mic is unmuted | It will remain unmuted and the user will able to publish audio without any restriction |
| Camera is unmuted | It will remain unmuted and the user will able to publish video without any restriction |
| Remote Peer is publishing audio | Able to play incoming audio from the room |

### iOS Behaviours when app goes to background without enabling blackground processing

| **Scenario**   | **Behaviours**                                 |
| :------------- | :----------------------------------------------------- |
| Mic is unmuted | It will get muted |
| Camera is unmuted | It will get muted |
| Remote Peer is publishing audio | Able to play incoming audio from the room |

### iOS Behaviours when app goes to background with enabling blackground processing
