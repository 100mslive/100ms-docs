...
Here `hmsVideoTrackInitState` property of `HMSVideoTrackSetting` and `hmsAudioTrackInitState` property of `HMSAudioTrackSetting` is enum of type `HMSTrackInitState` which has the possible values as:
...
HMSTrackSetting trackSetting = HMSTrackSetting(
        ...
        audioTrackSetting: HMSAudioTrackSetting(hmsAudioTrackInitState: HMSTrackInitState.MUTED),
        videoTrackSetting: HMSVideoTrackSetting(hmsVideoTrackInitState: HMSTrackInitState.UNMUTED));
```
