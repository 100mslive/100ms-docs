...
Flutter 3.0.x has some issues related to [Platform View](https://github.com/flutter/flutter/issues/107313).
Please update the flutter version to 3.3.x and it should work fine after that.

## Videos are not getting rendered at the correct position or video screen is coming over the buttons
Please check the flutter version this issue is likely happening due to usage of Flutter 3.0.x series.
This is due to an ongoing issue in Flutter 3.0.x which causes Native Platform Views to be drawn at incorrect position.
...
Update the flutter version to 3.3.x and it should work fine.
