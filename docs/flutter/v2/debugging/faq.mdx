...
This page lists down frequently asked questions specific to Flutter framework. If you want to add a new question or edit an older one, feel free to
[send us a PR](https://github.com/100mslive/100ms-docs/blob/main/docs/flutter/v2/debugging/faq.mdx).

If you are looking for generic frequently asked questions about the 100ms platform, please check the [common FAQ page](./../foundation/faq).
