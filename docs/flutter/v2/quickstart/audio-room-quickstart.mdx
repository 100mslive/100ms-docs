...
For creating audio room we will use the audio room template from [dashboard](https://dashboard.100ms.live/dashboard).

> For creating audio room we will use the audio room template from [dashboard](https://dashboard.100ms.live/dashboard) just like below.

<video loop="true" autoplay="autoplay" controls="controls" id="vid" muted>
    <source src="/docs/v2/flutter-audio-room-template.mov" type="video/mp4" />
</video>
...
<video loop="true" autoplay="autoplay" controls="controls" id="vid" muted>
    <source src="/docs/guides/flutter-audio-room-template.mov" type="video/mp4" />
</video>
<br />
...
In this audio room quickstart we are handling two roles namely `listener` and `speaker`.
...
- Checkout the repository [here](https://github.com/ygit/clubhouse_100ms)
