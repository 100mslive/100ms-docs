...
```dart
///Add the hms_room_kit import statement
...
You can now run the application and test it on your device. Just click on `Join` button to join the room.
...
That's it, You can now share screen and use PIP in your application.
