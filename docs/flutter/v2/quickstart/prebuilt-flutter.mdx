...
This guide will walk you through simple instructions to create a video conferencing app using 100ms prebuilt UI kit and test it using an emulator or your mobile phone.
...
Once you have created a Flutter app, you must add the hms_room_kit plugin to your project. To do this, follow the steps below:
