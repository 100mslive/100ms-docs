...
To test the application, you need to either connect your physical phone as a device in Android Studio or use an emulator. In this guide, we have connected a phone via USB to test the app.
