...
This guide contains instructions for two approaches to get you started with 100ms Flutter SDK as quickly as possible and to help you with a step-by-step approach.

1. [Create a sample app](#create-a-sample-app) — instructions to start with a flutter app with the complete code example.
2. [Building step-by-step](#building-step-by-step) — instructions to walk you through implementation of each feature/capability in a step-by-step manner.

You can also check our [sample app](https://github.com/100mslive/100ms-flutter/tree/main/example) for basic audio/video functionalities.
...
class _MeetingPageState extends State<MeetingPage>
  ...
  String authToken = "YOUR_APP_TOKEN_FROM_DASHBOARD";
