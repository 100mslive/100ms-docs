...
-   Introducing leaderboard APIs
    ...
    Users can now fetch rankings and quiz summary using the leaderboard. More information about leaderboard can be found [here](https://www.100ms.live/docs/flutter/v2/how-to-guides/interact-with-room/room/polls)
...
-   Introducing Quizzes
    ...
    More information about Quizzes can be found [here](https://www.100ms.live/docs/flutter/v2/how-to-guides/interact-with-room/room/polls).
...
-   Introducing Polls
    ...
    More information about Polls can be found [here](https://www.100ms.live/docs/flutter/v2/how-to-guides/interact-with-room/room/polls).
...
-   On Android, Screen share from a remote peer will now appear correctly in the center, occupying the space provided by the enclosing widget. Read more about Screen Share [here](https://www.100ms.live/docs/flutter/v2/how-to-guides/set-up-video-conferencing/screen-share).
...
-   Session Store
    ...
    Learn more about [Session Store here](https://www.100ms.live/docs/flutter/v2/how-to-guides/interact-with-room/room/session-store).
    ...
    Checkout more about updating for Session Store [here](/flutter/v2/how-to-guides/interact-with-room/room/session-store#migrating-from-older-hmssdk-version-to-160-or-above-for-using-session-store).
