---
title: Flutter HLS Streaming QuickStart Guide
nav: 2.4
---
...
4. You will see 100ms demo URLs for the roles created when you deployed the starter kit; you can click on the 'key' icon to copy the token and update the `authToken` for both the roles in "lib/main.dart" file.
