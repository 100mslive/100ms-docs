...
We will listen to `hlsStreamingStateUpdated` room update to get the update regarding HLS playback.
...
Checkout the repo [here](https://github.com/adityathakurxd/flutter-live)
