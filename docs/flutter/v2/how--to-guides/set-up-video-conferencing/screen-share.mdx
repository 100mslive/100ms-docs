...
### Migrating from older HMSSDK version to [1.5.0](https://github.com/100mslive/100ms-flutter/releases/tag/1.5.0) or above

Since there is a breaking change in the audio share setup in `1.5.0` version of HMSSDK compared to older versions.
Let's see how we can migrate from older versions to 1.5.0
