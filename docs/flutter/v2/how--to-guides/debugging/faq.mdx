...
To display mic or camera mute/unmute button based on role publish permissions checkout the doc [here](https://www.100ms.live/docs/flutter/v2/how--to-guides/set-up-video-conferencing/mute#when-to-show-mic-camera-mute-unmute-icon-on-ui)
