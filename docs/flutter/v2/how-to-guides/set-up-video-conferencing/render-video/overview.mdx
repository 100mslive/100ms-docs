...
This is a `bool` type parameter, `true` indicates that `HMSVideoView` can take the size of parent widget. It will have no impact on the functionality or behavior of the `HMSVideoView` component.
