...
HMSTextureView is an alternative and recommended way that can be used to display video streams. Flutter frameworks has some performance issues while using
...
/// Add scaleType image here, fit vs fill
...
track functionalities on your own. Default value is `null`
