...
HMSSDK's `toggleAlwaysScreenOn` method allows you to enable and toggle the screen Wakelock, which prevents the screen from turning off automatically.
...
or when using specific applications.
