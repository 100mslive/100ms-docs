...
> 💡 Note this option must selectively be turned off for devices based on their [models](https://developer.android.com/reference/android/os/Build#MODEL) disabling hardware echo cancellation for all devices will result in other devices echoing which didn't before.
