...
Harness the power of Music Mode to facilitate high-quality audio streaming. This is particularly advantageous when you have a use-case that involves streaming music captured through the microphone.
Elevate your audio game with Music Mode, Whether you're recording music, podcasts, or any other type of audio content, Music Mode empowers you to achieve high-quality recordings with full, rich sound.
...
class Meeting implements HMSUpdateListener{
    ...
    Meeting(){
        ...
        /// Continue with rest of the hmssdk method calls to join the room
