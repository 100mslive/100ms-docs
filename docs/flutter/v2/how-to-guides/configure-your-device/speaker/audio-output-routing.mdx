...
The `switchAudioOutputUsingiOSUI` allows you to display the native iOS UI for switching the audio output device.
Something similar to this:

<img src="/docs/v2/flutter-switch-audio.png" width="200" height="500" />

Let's look at the implementation:

```dart
///[hmsSDK] is the HMSSDK instance
hmsSDK.switchAudioOutputUsingiOSUI();
```