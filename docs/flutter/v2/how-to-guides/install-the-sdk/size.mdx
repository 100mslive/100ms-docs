...
The following table lists the size impact on flutter applications using 100ms [Prebuilt](https://pub.dev/packages/hms_room_kit), [Core SDK](https://pub.dev/packages/hmssdk_flutter) or [Virtual Background](https://pub.dev/packages/hms_video_plugin) packages.
