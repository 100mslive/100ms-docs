...
- Updated Screen share and Audio share implementation in android. Checkout the migration guide for [Screen share](https://www.100ms.live/docs/flutter/v2/how--to-guides/set-up-video-conferencing/screen-share#migrating-from-older-hmssdk-version-to-150-or-above) and [Audio share](https://www.100ms.live/docs/flutter/v2/how--to-guides/set-up-video-conferencing/local-audio-share#migrating-from-older-hmssdk-version-to-150-or-above)
...
To know more about camera controls and how to implement it in your application checkout the guide [here](https://www.100ms.live/docs/flutter/v2/how--to-guides/configure-your-device/camera/camera-controls)
...
Checkout the implementation [here](https://www.100ms.live/docs/flutter/v2/how--to-guides/set-up-video-conferencing/render-video/pip-mode#to-support-auto-enter-pip-below-android-12)
