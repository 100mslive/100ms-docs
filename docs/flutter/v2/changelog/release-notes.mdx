...
- `HMSMessage` will have a `messageId` property that allows to uniquely identify a message. Checkout the docs [here](https://www.100ms.live/docs/flutter/v2/how-to-guides/set-up-video-conferencing/chat#receiving-chat-messages)

### Changes 

- `matchParent` property of `HMSVideoView` is now deprecated and can be removed successfully.
