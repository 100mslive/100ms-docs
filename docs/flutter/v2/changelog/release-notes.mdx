...
- Session Store
  ...
  Checkout the migration guide [here](/flutter/v2/how-to-guides/interact-with-room/room/session-store#migrating-from-older-hmssdk-version-to-160-or-above-for-using-session-store)
