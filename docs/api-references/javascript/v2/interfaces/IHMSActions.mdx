...
| :-------- | :-------------------------------------------------------------------------------------- | :------------------------------------- |
| `request` | [`HMSRoleChangeRequest`](/api-references/javascript/v2/interfaces/HMSRoleChangeRequest) | The original request that was received |
...
| Name     | Type                                                              | Description                                             |
| :------- | :---------------------------------------------------------------- | :------------------------------------------------------ |
| `config` | [`HMSConfig`](/api-references/javascript/v2/interfaces/HMSConfig) | join config with room id, required for joining the room |
...
| Name       | Type                                                                                               | Description                                                               |
| :--------- | :------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------ |
| `settings` | `Partial`<[`HMSAudioTrackSettings`](/api-references/javascript/v2/classes/HMSAudioTrackSettings)\> | HMSAudioTrackSettings ({ volume, codec, maxBitrate, deviceId, advanced }) |
...
| Name       | Type                                                                                               | Description                                                                                    |
| :--------- | :------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------- |
| `settings` | `Partial`<[`HMSVideoTrackSettings`](/api-references/javascript/v2/classes/HMSVideoTrackSettings)\> | HMSVideoTrackSettings ({ width, height, codec, maxFramerate, maxBitrate, deviceId, advanced }) |
