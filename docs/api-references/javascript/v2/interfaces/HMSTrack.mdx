...
• `Optional` **layer**: [`HMSSimulcastLayer`](/api-references/javascript/v2/enums/HMSSimulcastLayer)

---

### layerDefinitions

• `Optional` **layerDefinitions**: [`SimulcastLayerDefinition`](/api-references/javascript/v2/interfaces/SimulcastLayerDefinition)[]
