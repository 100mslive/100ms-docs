...
| `hmsActions?`       | [`IHMSActions`](/api-references/javascript/v2/interfaces/IHMSActions) |
...
▸ **getHMSActions**(): [`IHMSActions`](/api-references/javascript/v2/interfaces/IHMSActions)
...
▸ **getNotifications**(): [`IHMSNotifications`](/api-references/javascript/v2/interfaces/IHMSNotifications)
...
▸ `Static` **createNewHMSStore**(): [`IHMSStore`](/api-references/javascript/v2/interfaces/IHMSStore)
...
### makeStoreTriggerOnSubscribe

▸ `Static` **makeStoreTriggerOnSubscribe**(`store`): `void`
